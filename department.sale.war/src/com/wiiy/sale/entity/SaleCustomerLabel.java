 ...
 */
public class SaleCustomerLabel extends BaseEntity implements Serializable {
	/** 
	 * 
	 */ 
	 ...
	 */
	@FieldDescription("分类")
	private SaleCustomerCategory category;
	/**
	 * 标签名称
	 */
	 ...
	 * 分类
	 */
	public SaleCustomerCategory getCategory(){
		return category;
	}
	public void setCategory(SaleCustomerCategory category){
