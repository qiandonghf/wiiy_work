		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean add = SaleActivator.getHttpSessionService().isInResourceMap("department_sale_project_add");
					boolean edit = SaleActivator.getHttpSessionService().isInResourceMap("department_sale_project_edit");
					boolean view = SaleActivator.getHttpSessionService().isInResourceMap("department_sale_project_view");
					boolean del = SaleActivator.getHttpSessionService().isInResourceMap("department_sale_project_delete");%>
					<%if(view){%>
