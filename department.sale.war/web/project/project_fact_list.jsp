		...
		$("#"+list).jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean edit = SaleActivator.getHttpSessionService().isInResourceMap("department_sale_project_fact_edit");
					boolean view = SaleActivator.getHttpSessionService().isInResourceMap("department_sale_project_fact_view");
					boolean del = SaleActivator.getHttpSessionService().isInResourceMap("department_sale_project_fact_delete");%>
					<%if(view){%>
