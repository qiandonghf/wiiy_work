...
<script type="text/javascript" >
					...
					$(form).ajaxSubmit({
				        ...
				        success: function(data){
				        	...
				        	if(data.result.success){
				        		setTimeout("getOpener().reloadList('registration');parent.fb.end();", 2000);
				        	}
				        } 
				    });
				}
	...
	function selectCustomer(customer){
		fbStart('选择客户','<%=basePath %>web/customer_selector.jsp',520,400);
	}
   ...
   <tr>
		...
		<td class="layerright">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
					<input id="customerId" name="registrationBook.customerId" type="hidden" class="inputauto" />
					<input id="customerName" name="customerName" readonly="readonly" type="text" class="inputauto" onclick="selectCustomer();" />
				</td>
					<td width="25" align="center">
						<img style="position: relative;left:-1px;" onclick="selectCustomer();" src="core/common/images/outdiv.gif" width="20" height="22" />
					</td>
				</tr>
			</table>
		</td>
    ...
    <tr>
       ...
       <td class="layerright"><input name="registrationBook.idCard" type="text" class="inputauto" /></td>
       <td class="layertdleft100">到期是否可销售：</td>
       <td class="layerright">
       	  <enum:radio checked="NO" name="registrationBook.whetherSales" type="com.wiiy.commons.preferences.enums.BooleanEnum" /> 
       </td>
    </tr>
    <tr>
       <td class="layertdleft100">业务编号：</td>
       <td class="layerright">
         <input name="registrationBook.businessCode" type="text" class="inputauto" />
       </td>
	   <td class="layertdleft100"><span class="psred">*</span>预订编号：</td>
       <td class="layerright">
         <input name="registrationBook.bookCode" type="text" class="inputauto" />
	   </td>
    </tr>
    <tr>
    ...
    <tr>
       ...
       <td class="layerright">
         <input name="registrationBook.reservationAmount" type="text" class="inputauto" onkeyup="value=value.replace(/[^\d\.]/g,'')" />
	   </td>
    </tr>
    <tr>
    ...
    <tr>
	   ...
	   <td class="layerright">
	     <input name="registrationBook.zipCode" type="text" class="inputauto"/>
	   </td>
	   <td class="layertdleft100">通讯地址：</td>
	   <td class="layerright">
	     <input name="registrationBook.adress" type="text" class="inputauto"/>
	   </td>
	 </tr>
	<tr>
	  <td class="layertdleft100">出租/出售：</td>
      <td class="layerright">
      	  <enum:select name="registrationBook.rentStatus" type="com.wiiy.sale.preferences.enums.RentEnum" /> 
      </td>
	  <td class="layertdleft100">是否同步到房间：</td>
      <td class="layerright">
      	  <enum:radio name="registrationBook.whetherRoom" type="com.wiiy.commons.preferences.enums.BooleanEnum" /> 
      </td>
	</tr>	
    <tr>
