	...
	$(document).ready(function() {
		...
		$("#timeClick").change(function(){
			if($(this).attr("checked")){
				$(".visittime").show();
				$("input[name='repeatedViste.remindTime']").val(getDate());
			}else{
...
<body>
<form action="<%=basePath %>repeatedViste!update.action" method="post" name="form1" id="form1">
<input type="hidden" name="repeatedViste.id" value="${result.value.id}" />
<div class="basediv">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
	        ...
	        <tr>
	          <td>
	          	<input id="receiverId" name="repeatedViste.receiverId"  readonly="readonly" type="hidden"/>
      ...
      <tr>
      	<td class="layertdleft100">回访时间：</td>
    		<td class="layerright">
	     		<table border="0" cellspacing="0" cellpadding="0">
			        <tr>
			          <td><input id="startTime" name="repeatedViste.startTime" type="text" readonly="readonly" class="inputauto" value="<fmt:formatDate value="${result.value.startTime }" pattern="yyyy-MM-dd"/>" onclick="showCalendar('startTime');"/></td>
      	...
      	<tr>
	        ...
	        <td class="layerright" colspan="3" style="padding-bottom:2px;">
	        	<textarea name="repeatedViste.memo" style="height:65px;" class="textareaauto">${result.value.memo }</textarea>
	        </td>
      	</tr>
      	<tr>
      	...
      	<td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <td width="10" class="visittime">
	          		<input name="repeatedViste.remindTime" readonly="readonly" type="text" value="<fmt:formatDate value="${result.value.remindTime }" pattern="yyyy-MM-dd"/>" class="inputauto" id="remindTime" onclick="return showCalendar('remindTime');" />
	          </td>
