	...
	<script type="text/javascript">
		...
		function initList(){
 			...
 			$("#list").jqGrid({
 				...
 				gridComplete: function(){
 					...
 					for(var i = 0 ; i < ids.length; i++){
 						...
 						<%boolean add = SaleActivator.getHttpSessionService().isInResourceMap("sale_rent_add");
 						boolean edit = SaleActivator.getHttpSessionService().isInResourceMap("sale_rent_edit");
 						boolean view = SaleActivator.getHttpSessionService().isInResourceMap("sale_rent_view");
 						boolean del = SaleActivator.getHttpSessionService().isInResourceMap("sale_rent_delete");
 						boolean launch = SaleActivator.getHttpSessionService().isInResourceMap("sale_rent_launch");%>
 		...
 		function launchById(id){
 			...
 			var openUrl = "";
 			openUrl = '<%=BaseAction.rootLocation%>/parkmanager.pf/bill!addByPlanId.action?contractId=${result.value.id }&department=SALE&id='+id;//弹出窗口的url
