...
<title>无标题文档</title>
	...
	<script type="text/javascript">
		...
		function setSelectedRoom(room){
			$("#"+clicked).val(room.name);
			$("#"+clicked+"Id").val(room.id);
		}
	</script>
</head>
<body>
			...
			<tr>
				...
				<td class="layerright">
					<table width="143" border="0" cellspacing="0" cellpadding="0">
				        <tr>
				          <td>
				          	<input id="roomId" name="contract.roomId" type="hidden"/>
				         	<input id="room" class="inputauto" onclick="selectRoom('room')" readonly="readonly"/></td>
				          <td width="21" align="center"><img src="core/common/images/outdiv.gif" width="20" height="22" onclick="selectRoom('room')" style="cursor:pointer"/></td>
				        </tr>
		    		</table>
		    	</td>
	       	...
	       	<tr>
				...
				<td class="layerright">
					<enum:select name="contract.contractType" type="com.wiiy.common.preferences.enums.ContractTypeEnum" checked="result.value.contractType"/>
			    </td>
