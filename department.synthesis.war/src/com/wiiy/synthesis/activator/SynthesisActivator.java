package com.wiiy.synthesis.activator;
...
import com.wiiy.synthesis.system.DataDictInit;

public class SynthesisActivator extends AbstractActivator {
	...
	public void startBundle(BundleContext context) throws Exception {
		...
		logger.debug("bundle 【department.synthesis.war】 start");
		//initProcess();
	}
