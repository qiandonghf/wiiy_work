  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="153">
            <input id="carLicenseNo" name="carFix.licenseNo" type="text" class="inputauto" onclick="fbStart('车辆选择','<%=basePath%>car!carSelect.action',400,240);"/>
            <input id="carId" name="carFix.carId" type="hidden"/>
          </td>
          <td><img src="core/common/images/outdiv.gif" width="20" height="22" style="cursor:pointer;relative; left:-1px;" onclick="fbStart('车辆选择','<%=basePath%>car!carSelect.action',400,240);"/></td>
        </tr>
      </table></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="layerright">
      	<dd:select id="carFixTypeId" name="carFix.carFixTypeId" key="syn.0003" />
      </td>
    </tr>
    <tr>
