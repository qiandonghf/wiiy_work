    ...
    <tr>
      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="layerright">
          		<enum:select type="com.wiiy.synthesis.preferences.enums.CarStatusEnum" name="car.status" styleClass="incubated"/>  
            </td>
          </tr>
          <tr>
            <td class="layertdleft100"><span class="psred">*</span>车辆类型：</td>
            <td class="layerright">
            	<dd:select id="carTypeId" name="car.carTypeId" key="syn.0002"/> 
            </td>
          </tr>
          <tr>
      ...
      <td width="260" valign="top"><table style=" padding-top:3px;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="186"><img id="car_imagery_img" class="synthesis_img" src="core/common/images/nopic.jpg" width="180" height="185" /></td>
