...
<div class="emailtop">
	<div class="leftemail">
		<ul>
			<li style="background-color:#D2E6FF" onmouseover="this.className='libg'" onmouseout="this.className=''"  onclick="location.href='<%=basePath %>workDayReport!employeeDayCountList.action'"><span><img src="core/common/images/daylycount.gif" /></span>日报</li>
