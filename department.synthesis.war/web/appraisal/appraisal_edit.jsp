...
<body>
<form action="<%=basePath %>appraisal!update.action" method="post" name="form1" id="form1">
<input type="hidden" id="id" name="appraisal.id" value="${result.value.id }"/>
...
<div class="divlays" style="margin:0px;">
	<table class="mainClass" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
     		...
     		<td class="layerright">
     			<input type="text" name="appraisal.name"  class="inputauto" value="${result.value.name }" />
		    </td>
		</tr>
		<tr>
     		...
     		<td class="layerright">
	     		<table border="0" cellspacing="0" cellpadding="0">
			        <tr>
					   <enum:select name="appraisal.appraisalType"   type="com.wiiy.synthesis.preferences.enums.AppraisalTypeEnums" checked="result.value.appraisalType" />
			        </tr>
			    </table>
		    </td>
		</tr>
		<tr>
     		...
     		<td class="layerright" colspan="2">
	     		<table border="0" cellspacing="0" cellpadding="0">
			        <tr>
			          <td><input id="time" type="text" name="appraisal.time" value='<fmt:formatDate value="${result.value.time }" pattern="yyyy-MM-dd" />' readonly="readonly" class="inputauto" onclick="showCalendar('time');"/></td>
		...
		<tr>
       	...
       	<tr>
			...
			<td class="layerright" colspan="3">
	    		<textarea name="appraisal.memo" class="inputauto" style="resize:none;height:80px;">${result.value.memo }</textarea>
			</td>
       	</tr>
  </table>
  </div>
