		...
		$("#"+list).jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%boolean add = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_department_project_fact_add");
					boolean edit = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_department_project_fact_edit");
					boolean view = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_department_project_fact_view");
					boolean del = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_department_project_fact_delete");%>
					<%if(view){%>
