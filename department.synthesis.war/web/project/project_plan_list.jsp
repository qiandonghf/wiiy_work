		...
		$("#"+list).jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean edit = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_department_project_plan_edit");
					boolean view = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_department_project_plan_view");
					boolean del = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_department_project_plan_delete");%>
					<%if(view){%>
