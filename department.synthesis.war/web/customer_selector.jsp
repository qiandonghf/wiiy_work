		 ...
		 $("#browser").tree({
			...
			onClick: function(node){
				if($(this).tree("isLeaf",node.target)){
					loadCustomerByType($(node.target).find("input").val());
				}
			},
			onLoadSuccess: function (data) {
				$("#browser").children().eq(0).children().eq(0).addClass("tree-node-selected");
            }
		}); 
		initList();
	});
					...
					<div class="userleftcontact" id="resizable">
						...
						<div class="treeviewdiv" style="overflow-Y:auto;height: 320px;" id="treeviewdiv">
							<ul id="browser" class="filetree">
								<li>
									<span class="file" onclick="loadAllCustomer()">所有客商</span>
								</li>
								<li>
