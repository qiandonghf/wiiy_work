...
<body>
<form action="<%=basePath %>seal!save.action" method="post" name="form1" id="form1">
<div class="basediv">
<div class="divlays" style="margin:0px;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
       	<tr>
			...
			<td class="layerright">
				<input id="name" name="seal.name" type="text" class="inputauto" style="width: 70%" />
			</td>
       	</tr>
       	<tr>
		    <td class="layertdleft100">印章类别：</td>
			<td class="layerright">
				<dd:select key="syn.0001" name="seal.sealType" />
			</td>
       	</tr>
       	<tr>
            <td class="layertdleft">所属部门：</td>
              <td class="layerright"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
					<td width="50%"><input id="orgId" name="seal.orgId" type="hidden" /><input id="orgName" name="orgName" class="inputauto" readonly="readonly" onclick="fbStart('选择部门','<%=BaseAction.rootLocation %>/core/org!select.action',520,400);"/></td>
