...
<input type="hidden" value="SAGREE" name="sealRegistration.status"/>
<div class="basediv">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
       	<tr>
			...
			<td class="layerright">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="20%"><input id="userId" name="sealRegistration.userId" type="hidden" /><input id="userName" name="userName" readonly="readonly" type="text" class="inputauto" onclick="selectUser()" /></td>
