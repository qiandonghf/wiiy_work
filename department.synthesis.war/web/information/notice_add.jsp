...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td class="layerright"><input name="notice.issuer" value="<%=SynthesisActivator.getAppConfig().getConfig("NoticeSign").getParameter("name") %>" type="text" class="inputauto" /></td>
      </tr>
      <tr>
