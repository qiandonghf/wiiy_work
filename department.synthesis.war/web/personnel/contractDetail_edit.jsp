...
<script type="text/javascript">
	...
	function uploadSuccess(file, data, response){
		...
		var postData = {"contractDetailAtt.contractDetailId":$("#contractDetailId").val(),"contractDetailAtt.name":file.originalName,"contractDetailAtt.newName":file.path,"contractDetailAtt.size":file.size};
		$.post("<%=basePath%>contractDetailAtt!save.action",postData,function(callbackData){
	...
	function deleteAtt(id){
		$.post("<%=basePath %>contractDetailAtt!delete.action?id="+id,function(data){
			$("#li"+id).remove();
		});			
	}
	function initForm(){
		$("#form1").validate({
			...
			messages: {
				"contractDetail.contracta":"请输入甲方",
				"contractDetail.contractb":"请输入乙方",
...
<body>
<form action="<%=basePath %>contractDetail!update.action" method="post" name="form1" id="form1">
<input id="contractDetailId" name="contractDetail.id" value="${result.value.id }" type="hidden" />
<!--basediv-->
<div class="basediv">
	<!--titlebg-->
	<!--//titlebg-->
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="layerright"><input name="contractDetail.contracta" type="text" class="inputauto" value="${result.value.contracta }"/></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>乙方：</td>
      <td class="layerright"><input name="contractDetail.contractb" type="text" class="inputauto" value="${result.value.contractb }"/></td>
    </tr>
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>合同名称：</td>
      <td class="layerright"><input name="contractDetail.contractName" type="text" class="inputauto" value="${result.value.contractName }"/></td>
    </tr>
    <tr>
	...
	<tr>
		...
		<td class="layerright">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><input name="contractDetail.signingDate" readonly="readonly" type="text" class="inputauto" id="signingDate" onclick="return showCalendar('signingDate');" value="<fmt:formatDate value="${result.value.signingDate}" pattern="yyyy-MM-dd"/>"/></td>
	...
	<tr>
      ...
      <td class="layerright"><input name="contractDetail.money" type="text" class="inputauto" value="${result.value.money }" /></td>
    </tr>
     <tr>
      <td class="layertdleft100"><span class="psred">*</span>合同描述：</td>
      <td class="layerright"><input name="contractDetail.contractContext" type="text" class="inputauto" value="${result.value.contractContext }"/></td>
    </tr>
	<tr>
