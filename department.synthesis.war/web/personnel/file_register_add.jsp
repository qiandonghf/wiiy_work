  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <tr>
	      <td width="118">
	        <enum:select name="archives.status" type="com.wiiy.synthesis.preferences.enums.PositionConditionEnum"/>
	      </td>
	     </tr>
	    </table></td>
      </tr>
    ...
    <td width="175" valign="top"><table style=" padding-top:3px;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="110"><img id="archives_imagery_img" class="synthesis_img" src="core/common/images/topxiao.gif" width="110" height="123" /></td>
