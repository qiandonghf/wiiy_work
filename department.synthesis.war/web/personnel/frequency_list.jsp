		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean add = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_workClass_add");
					boolean edit = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_workClass_edit");
					boolean delete = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_workClass_del");
					boolean view = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_workClass_view");
					%>
					<%if(view){%>
