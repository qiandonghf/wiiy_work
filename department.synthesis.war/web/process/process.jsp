		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					var content = "";
					<%boolean add = EngineeringActivator.getHttpSessionService().isInResourceMap("synthesis_process_add");
					boolean edit = EngineeringActivator.getHttpSessionService().isInResourceMap("synthesis_process_edit");
					boolean delete = EngineeringActivator.getHttpSessionService().isInResourceMap("synthesis_process_delete");
					boolean state = EngineeringActivator.getHttpSessionService().isInResourceMap("synthesis_process_changeState");%>
