...
<%@page import="com.wiiy.engineering.activator.com.wiiy.engineering.activator.EngineeringActivator"%>
<%@ page language="java" import="java.util.*,com.wiiy.commons.action.BaseAction" pageEncoding="UTF-8"%>
<%@ taglib prefix="enum" uri="http://www.wiiy.com/taglib/enum" %>
<%@page import="com.wiiy.common.preferences.SealTypeEnum"%>
...
%>
<%
	User user = EngineeringActivator.getSessionUser(request);
%>
      ...
      <td valign="top">      
         ...
         <div class="basediv" style="min-width:600px;">
			<div class="divlays" style="margin:0px;">
              <table id="insertTxt" width="100%" border="1" cellspacing="0" cellpadding="0">
				<tr>
					<td colspan="4">
						<div class="titlebg2" style="text-align:center;margin:1px 1px 0px 1px;"><strong><c:if test="${!inpark }">用章申请表<input type="hidden" name="fictitious.inpark" value="<%=BooleanEnum.NO%>"/></c:if><c:if test="${inpark }">审批表(入驻)<input type="hidden" name="fictitious.inpark" value="<%=BooleanEnum.YES%>"/></c:if></strong></div>
					</td>
				</tr>
				<tr>
					<td class="layertdleft100">申请部门：</td>
					<td width="29%" class="layerright"><input id="name" disabled value="<%=(user == null ? "" :user.getRealName()) %>" type="text" class="inputauto" /></td>
					<td width="40%" class="layertdleft100">日期：</td>
				...
				<tr>
					...
					<td class="layerright" >
						<table width="143" border="0" cellspacing="0" cellpadding="0">
					        <tr>
					          <td>
					          	<input id="customerId" name="customer.customerId" type="hidden"/>
					          	<input id="name" name="customer.name" class="inputauto" onclick="selectUser('name')" readonly="readonly"/></td>
					          <td width="21" align="center"><img src="core/common/images/outdiv.gif" width="20" height="22" onclick="selectUser('name')" style="cursor:pointer"/></td>
					        </tr>
				   		</table>
				   	</td>
		       		<td class="layertdleft100">文件名称：</td>
					<td style="background-color: wirte" class="layerright"><input name="customer.code" type="text" class="inputauto pinput" value="" /></td>
       		</tr>
       		<tr>
	       	    <td class="layertdleft100">文件内容：</td>
		    	<td colspan="3" class="layerright" style="padding-bottom:3px;">
		    		<textarea name="customer.customerInfo" class="inputauto" style="resize:none;height:40px;"></textarea>
		    	</td>
       		</tr>
       		<tr>
	       	    <td class="layertdleft100">用印类型：</td>
		    	<td colspan="3" class="layerright" style="padding-bottom:3px;">
		    		<textarea name="customer.customerInfo" class="inputauto" style="resize:none;height:40px;"></textarea>
		    	</td>
       		</tr>
       		<tr>
	       	    <td class="layertdleft100">部门负责人意见：</td>
		    	<td colspan="3" class="layerright" style="padding-bottom:3px;">
		    		<textarea name="customer.customerInfo" class="inputauto" style="resize:none;height:40px;"></textarea>
		    	</td>
       		</tr>
       		<tr>
	       	    <td class="layertdleft100">分管领导意见：</td>
		    	<td colspan="3" class="layerright" style="padding-bottom:3px;">
		    		<textarea name="customer.customerInfo" class="inputauto" style="resize:none;height:40px;"></textarea>
		    	</td>
       		</tr>
       		<tr>
	       	    <td class="layertdleft100">主任/总经理意见：</td>
		    	<td colspan="3" class="layerright" style="padding-bottom:3px;">
		    		<textarea name="customer.customerInfo" class="inputauto" style="resize:none;height:40px;">
		    		默认：杭州华业高科技产业园（负责人）
		    		</textarea>
		    	</td>
       		</tr>
       		<tr>
	       	    <td class="layertdleft100">盖章人确认：</td>
		    	<td colspan="3" class="layerright" style="padding-bottom:3px;">
		    		<textarea name="customer.customerInfo" class="inputauto" style="resize:none;height:40px;">
		    		默认：华业科技园--综合事务部--盖章人
		    		</textarea>
