...
<script type="text/javascript">
	...
	function initList(){
		...
		$("#list").jqGrid({
	    	url:'<%=basePath%>contract!list.action?times=${param.time}',
			colModel: [
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean add = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_contract_add");
					boolean edit = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_contract_view");
					boolean view = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_contract_edit");
					boolean del = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_contract_delete");%>
					<%if(view){%>
