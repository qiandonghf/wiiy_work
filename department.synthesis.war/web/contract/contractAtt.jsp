 			...
 			$("#list").jqGrid({
 				...
 				gridComplete: function(){
 					...
 					for(var i = 0 ; i < ids.length; i++){
 						var id = ids[i];
 						var content = "";
 						<%boolean attAdd = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_file_add");
 						boolean attEdit = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_file_edit");
 						boolean attView = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_file_view");
 						boolean attDel = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_file_delete");%>
