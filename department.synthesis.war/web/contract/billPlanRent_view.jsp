	...
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="layerright"><fmt:formatDate pattern="yyyy-MM-dd" value="${result.value.startDate}"/>&nbsp;&nbsp;<label><input name="billPlanRent.audit" disabled="disabled" type="checkbox" <c:if test="${result.value.audit eq 'YES' }">checked="checked"</c:if> onclick="changeState(this);" /><span>未审核</span></label></td>
			</tr>
			<tr>
