	...
	<script type="text/javascript">
		...
		function initForm(){
 		...
 		<%-- function selectPlan(){
 			...
 			if(rentId != '' && rentName != ''){
	 			fbStart('选择结算计划','<%=basePath %>web/contract/billPlanRent_selector.jsp?id='+rentId+'&name='+rentName+'&contractId='+id,550,358);
 			}else{
	 			fbStart('选择结算计划','<%=basePath %>web/contract/billPlanRent_selector.jsp?contractId='+id,550,358);
 			}
 		}
...
<body>
<form action="<%=basePath %>billRent!save.action" method="post" name="form1" id="form1">
<input type="hidden" name="billRent.contractId" value="${result.value.id }"/>
<div class="basediv">
<div class="divlays" style="margin:0px;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
       	<tr>
			...
			<td class="layerright">
	          	<input id="billRentId" name="billRent.billPlanRentId" value="${result.value.id }" type="hidden"/>
	          	<input id="billRentName" name="billRentName" class="inputauto" value="${result.value.code }" readonly="readonly"/>
			</td>
       		<td class="layertdleft100" >预计结算：</td>
       		<td class="layerright" >
				<input id="planFee" value="${result.value.planFee }" readonly="readonly" type="text" class="inputauto" />
		    </td>
       	</tr>
       	<tr>
       		<td class="layertdleft100" >预计结算日期：</td>
	      	<td class="layerright" >
				<input id="planPayDate" value='<fmt:formatDate value="${result.value.planPayDate }" pattern="yyyy-MM-dd" />' readonly="readonly" type="text" class="inputauto" />
	      	</td>
       	...
       	<tr>
			...
			<td class="layerright" >
				<input class="inputauto" value="${result.value.contract.ext1 }" readonly="readonly" />
		   	</td>
       	</tr>
       	<tr>
	      	...
	      	<td class="layerright" >
	      		<table width="143" border="0" cellspacing="0" cellpadding="0">
		        	<tbody>
			          <tr>
			            <td>
			            	<input id="settlementDate" name="billRent.settlementDate" readonly="readonly" type="text" class="inputauto" onclick="showCalendar('settlementDate')"/>
			            </td>
       		...
       		<td class="layerright" >
				<input name="billRent.settlementFee" type="text" class="inputauto" value="0.00" />
		    </td>
       	</tr>
       	<tr>
     		<td class="layertdleft100">结算性质：</td>
       		<td class="layerright">
       			<enum:select type="com.wiiy.common.preferences.enums.SettlementNatureEnum" name="billRent.settlementType" />
       		</td>
       		<td class="layertdleft100"><span class="psred">*</span>收付方向：</td>
       		<td class="layerright">
       			<enum:select type="com.wiiy.common.preferences.enums.PaymentTypeEnum" name="billRent.payment" />
       		</td>
       	</tr>
       	<tr>
       		<td class="layertdleft100">结算方式：</td>
       		<td class="layerright">
       			<enum:select type="com.wiiy.common.preferences.enums.SettlementTypeEnum" name="billRent.settlement" />
       		</td>
		    <td class="layerright" colspan="2">
				<label><input name="billRent.audit" type="checkbox" onclick="changeState(this);" value="<%=BooleanEnum.NO %>" /><span>未审核</span></label>
	      	</td>
       	</tr>
       	<tr>
       	    <td class="layertdleft100">备注：</td>
	    	<td class="layerright" colspan="3" style="padding-bottom:3px;">
	    		<textarea name="billRent.memo" class="inputauto" style="resize:none;height:40px;"></textarea>
	    	</td>
       	</tr>
