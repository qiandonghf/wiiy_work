	...
	<script type="text/javascript">
		...
		function initList(){
 			...
 			$("#list").jqGrid({
 				...
 				gridComplete: function(){
 					...
 					for(var i = 0 ; i < ids.length; i++){
 						...
 						boolean launch = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_rent_launch");%>
 		...
 		function launchById(id){
 			...
 			var openUrl = "";
 			openUrl = '<%=BaseAction.rootLocation%>/parkmanager.pf/bill!addByPlanId.action?contractId=${param.id }&department=SYNTHESIS&id='+id;//弹出窗口的url
