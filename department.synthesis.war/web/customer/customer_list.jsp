		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					<%boolean add = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_supplier_add") || 
							SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_customer_add");
						boolean edit = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_supplier_edit") || 
							SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_customer_edit");
						boolean view = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_supplier_view") || 
							SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_customer_view");
						boolean delete = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_supplier_delete") || 
							SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_customer_delete");%>
					<%if(view){%>
