	...
	<div style="height:233px;">
		<div class="apptab" id="tableid">
			<ul>
				<%
					int flag=-1;
						boolean company = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_supplier_add_company") ||
								SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_customer_add_company");
						boolean register = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_supplier_add_register") ||
								SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_customer_add_register");
						boolean ohter = SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_supplier_add_other") ||
								SynthesisActivator.getHttpSessionService().isInResourceMap("synthesis_customer_add_other");
						if(register){flag++;
				%>
