...
<div id="header">
  ...
  <div id="headerdown"> 
    <!--logo-->
    <div id="logo2"><img src="core/web/newdesktop/images/logo_yuanqu.png" height="60" /></div>
    <!--//logo--> 
    <!--nav-->
    <div id="nav_new">
      <ul id="mini_nav">
        <li class="nav1"><a  href="parkmanager.oa_new/indexv2_xinxi.html" title="信息"></a></li>
        <li class="nav2"><a href="#" title="汇报"></a></li>
        <li class="nav3"><a href="parkmanager.oa_new/indexv2_liucheng.html" title="流程"></a></li>
...
<div id="contant">
		...
		<tr>
			<td>
				<div id="sub2" style="display:block;">
					<div id="subnav" style="height: 489px">
						<div id="topico">
							<ul>
								<li>
					...
					<!--sildebottom-->
			          ...
			          <div class="centercon">
			            <div class="centerconlist2">
			                <ul>
			                    <li class="current">
			                      <a href="core/web/newdesktop/indexv1_01.html"><img title="园区动力" src="core/web/newdesktop/images/dongli_ico.png" /></a>
			                    </li>
			                <li><a href="core/web/newdesktop/indexv2_01.html"><img title="任务分配" src="core/web/newdesktop/images/renwu_ico.png" /></a></li>
	...
	<div id="footer">Copyright ©2012 www.huaye.com.cn | TEL:0571-85613587</div>
</div>
<script type="text/javascript">
