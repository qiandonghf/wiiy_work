...
function loadDetail(id, withVars, callback) {
    ...
    $.getJSON('/activiti/leave!detail.action?id=' + id, function(data) {
        detail = data.leave;
...
function loadDetailWithTaskVars(leaveId, taskId, callback) {
    ...
    $.getJSON('/activiti/leave!loadLeaveWithVars.action?id=' + leaveId + '&taskId=' + taskId, function(data) {
        detail = data;
...
function complete(taskId, variables) {
	...
	alert('发送任务完成请求');
    $.post('/activiti/leave!complete.action?taskId=' + taskId, {
        keys: keys,
        values: values,
        types: types
    }, function(resp) {
        ...
        if (resp.message == 'success') {
            alert('任务完成');
            location.href='/activiti/leave!taskList.action';
        } else {
            alert('操作失败!');
        }
    });
