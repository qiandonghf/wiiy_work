...
<head>
	...
	<script src="/activiti/js/module/form/dynamic/dynamic-form-handler.js" type="text/javascript"></script>
</head>
		...
		<tr>
			...
			<td>
				<c:if test="${empty task.assignee }">
					<a class="claim" href="/activiti/form/dynamic/task/claim/${task.id}">签收</a>
				</c:if>
