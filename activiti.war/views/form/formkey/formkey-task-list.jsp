...
<head>
	...
	<script src="/activiti/js/module/form/formkey/formkey-form-handler.js" type="text/javascript"></script>
</head>
		...
		<tr>
			...
			<td>
				<c:if test="${empty task.assignee }">
					<a class="claim" href="/activiti/form/formkey/task/claim/${task.id}">签收</a>
				</c:if>
