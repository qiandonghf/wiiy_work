...
<head>
	...
	<script src="/activiti/js/common/plugins/validate/jquery.validate.pack.js" type="text/javascript"></script>
	<script src="/activiti/js/common/plugins/validate/messages_cn.js" type="text/javascript"></script>
	...
	<script src="/activiti/js/module/form/formkey/formkey-form-process-list.js" type="text/javascript"></script>
</head>
		...
		<tbody>
			<c:forEach items="${page.result }" var="process">
				<tr>
					...
					<td><a target="_blank" href='/activiti/workflow/resource/read?processDefinitionId=${process.id}&resourceType=xml'>${process.resourceName }</a></td>
					<td><a target="_blank" href='/activiti/workflow/resource/read?processDefinitionId=${process.id}&resourceType=image'>${process.diagramResourceName }</a></td>
