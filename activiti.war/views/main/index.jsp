...
<%@page import="me.kafeitu.demo.activiti.util.UserUtil"%>
...
<head>
	...
	<script>
		var logon =<%= UserUtil.getUserFromSession(session)%>
		if (!logon) {
			location.href = '/activiti/views/login.jsp?timeout=true';
		}
	</script>
    ...
    <link rel="stylesheet" type="text/css" href="/activiti/css/menu.css" />
    <%@ include file="/common/include-custom-styles.jsp" %>
	<link href="/activiti/css/main.css" type="text/css" rel="stylesheet"/>
	<style type="text/css">
    ...
    <script src="/activiti/js/common/plugins/jui/extends/themeswitcher/jquery.ui.switcher.js" type="text/javascript"></script>
    <script src="/activiti/js/common/plugins/tools/jquery.cookie.js" type="text/javascript"></script>
	<script src="/activiti/js/common/plugins/jui/extends/layout/jquery.layout.min.js?v=1.3" type="text/javascript"></script>
	<script src='/activiti/js/common/common.js' type="text/javascript"></script>
    <script src='/activiti/js/module/main/main-frame.js' type="text/javascript"></script>
</head>
<body>
<!-- #TopPane -->
<div id="topPane" class="ui-layout-north ui-widget ui-widget-header ui-widget-content">
	<div style="padding-left:5px; font-size: 16px; margin-top: 1px;">
       	<table id="topTable" style="padding: 0px;margin: 0px;margin-top: -5px" width="100%">
       		<tr>
       			<td width="40px">
       				<img src="/activiti/images/logo.png" height="48" align="top"  style="margin-top:5px" />
       			</td>
       			<td>
       			...
       			<td>
       				<div style="float:right; color: #fff;font-size: 12px;margin-top: 2px">
		        		<div>
		        			...
		        			<span title="角色：${sessionScope.groupNames }">${sessionScope.user.firstName } ${sessionScope.user.lastName }/${user.id }</span>
		        		</div>
...
<div id="centerPane" class="ui-layout-center ui-helper-reset ui-widget-content">
	<div id="tabs">
		...
		<div id="tab-index">
			<iframe id="mainIframe" name="mainIframe" src="/activiti/views/main/welcome.jsp" class="module-iframe" scrolling="auto" frameborder="0" style="width:100%;height:100%;"></iframe>
		</div>
	</div>
</div>
...
<div id="bottomPane" class="ui-layout-south ui-widget ui-widget-content">
	<div class="footer ui-state-default">
		<a href="http://www.wiiy.com" target="_blank">aswan</a>
