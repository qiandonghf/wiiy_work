...
<head>
    ...
    <link href="/activiti/js/common/plugins/jui/extends/portlet/jquery.portlet.min.css?v=1.1.2" type="text/css" rel="stylesheet" />
    <link href="/activiti/js/common/plugins/qtip/jquery.qtip.css?v=1.1.2" type="text/css" rel="stylesheet" />
    ...
    <script src="/activiti/js/common/plugins/jui/extends/portlet/jquery.portlet.pack.js?v=1.1.2" type="text/javascript"></script>
    ...
    <script src="/activiti/js/module/main/welcome-portlet.js" type="text/javascript"></script>
</head>
