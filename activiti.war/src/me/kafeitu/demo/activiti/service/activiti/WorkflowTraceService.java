...
public class WorkflowTraceService {
    ...
    public List<Map<String, Object>> traceProcess(String processInstanceId) throws Exception {
        ...
        if(execution!=null)property=PropertyUtils.getProperty(execution, "activityId");
        String activityId = "";
        if (property != null) {
...
//    }
    ...
    private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity, HistoricProcessInstance processInstance,
        ...
        if (activityBehavior instanceof UserTaskActivityBehavior) {
            ...
            if (currentActiviti) {
            	...
            	ProcessInstance instance=runtimeService.createProcessInstanceQuery().processInstanceId(processInstance.getId()).singleResult();
                currentTask = getCurrentTaskInfo(instance);
            }
    ...
    private void setTaskGroup(Map<String, Object> vars, Set<Expression> candidateGroupIdExpressions) {
        ...
        for (Expression expression : candidateGroupIdExpressions) {
            ...
            Group g= identityService.createGroupQuery().groupId(expressionText).singleResult();
            if(g!=null)
            	roleName=g.getName();
            roles += roleName;
        }
