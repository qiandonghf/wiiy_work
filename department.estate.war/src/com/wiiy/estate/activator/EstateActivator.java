package com.wiiy.estate.activator;
...
import com.wiiy.estate.system.DataDictInit;
import com.wiiy.external.service.OperationLogPubService;


public class EstateActivator extends AbstractActivator {
	...
	protected void registryFK(){
		...
		if (fkServiceRef != null) {
			...
			fkService.registryFK(getFKDescription(bundleContext,"WEB-INF/classes/com/wiiy/estate/entity/"));
		} else {
