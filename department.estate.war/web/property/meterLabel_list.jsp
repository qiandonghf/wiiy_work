...
<script type="text/javascript">
	$(document).ready(function() {
		...
		//分页设置宽度和长度
		$(".page").css("width",$("#lsittable").width());
		$(".page").css("padding","0px 0px");
	});
...
<div class="emailtop">
			...
			<div class="leftemail">
				<ul>
				<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_hydropower_meterLabel_add")){ %>
    ...
    <tr>
	  ...
	  <div class="write_list" style="border-right:1px solid #ddd; width:355px;" id="resizable">
        ...
        <div id="materLabelDiv" style="overflow-x: hidden;overflow-y:auto;">
            ...
            <!--分页开始-->
			<div class="page" style="border-top:none;position: absolute;margin-left: 0px;margin-right: 0px;bottom: 0px;">
