...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="layerright">	
      	 <enum:select type="com.wiiy.common.preferences.enums.MeterTypeEnum" name="selfMeterLabel.type"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="layerright"  colspan="3">
      	   ...
      	   <input type="hidden" name="selfMeterLabel.reader" value="<%=EstateActivator.getSessionUser(request).getRealName()%>"/>
      </td>
    </tr>
    <tr>
