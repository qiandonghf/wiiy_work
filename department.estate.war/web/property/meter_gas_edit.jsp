...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="layerright">
      	 <enum:select type="com.wiiy.estate.preferences.enums.MeterKindEnum" name="meter.kind" checked="meter.kind"/>
      </td>
    </tr>
    <tr>
      ...
      <td class="layerright">
     	 <enum:select type="com.wiiy.estate.preferences.enums.MeterStatusEnum" name="meter.status" checked="meter.status"/>
      </td>
    </tr>
    <tr>
