...
<div id="container">
	...
	<h1 style="text-align:center; font-size:2em;">电费结算单</h1>
      	...
      	<tr>
			...
			<tbody>
			    ...
			    <c:forEach items="${ price}" var="price">
			        <c:set value="${ price.electricity}" var="pe"></c:set>
			    </c:forEach>
					    ...
					    <td><input type="text" id="${list.meterLabelRecord.id }_totalAmount" name="" class="input" value="<fmt:formatNumber pattern="#0.00" value="${list.meterLabelRecord.totalAmount}" />" style="width:100%;border:0;" readonly="readonly"/></td>
	      				...
	      				<c:choose>   
	      				    <c:when test="${list.meterLabelRecord.price==null}">
	      				        <td><span class="pointSpan"><input type="text" id="${list.meterLabelRecord.id }_price" name="" class="input" value="<fmt:formatNumber pattern="#0.00" value="${pe}" />" style="width:100%;" onfocus="checkData(${list.meterLabelRecord.id});" onkeyup="checkPrice(this,${list.meterLabelRecord.id});"/></span></td>
	      				    </c:when>
	      				    <c:otherwise>
	      				        <td><span class="pointSpan"><input type="text" id="${list.meterLabelRecord.id }_price" name="" class="input" value="<fmt:formatNumber pattern="#0.00" value="${list.meterLabelRecord.price}" />" style="width:100%;" onfocus="checkData(${list.meterLabelRecord.id});" onkeyup="checkPrice(this,${list.meterLabelRecord.id});"/></span></td>
	      				    </c:otherwise>
					    </c:choose>
