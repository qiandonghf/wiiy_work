...
<body>
<form id="form1" name="form1" method="post" action="<%=basePath%>fixFee!save.action">
<div class="basediv">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><span class="layerright">
        <input name="fixFee.maintainer" type="text" class="input100" />
      </span></td>
      <td class="layertdleft100"><span class="psred">*</span>维修人员所属单位：</td>
      <td><span class="layerright">
        <input name="fixFee.maintainerOrg" type="text" class="input200" />
      </span></td>
    </tr>
    <tr>
    <td class="layertdleft100">人工费用：</td>
      <td class="layerright">
        <input name="fixFee.laborCosts" type="text" class="input100" />     </td>
      <td class="layertdleft100">材料费用：</td>
      <td class="layerright">
      	<input name="fixFee.materialCosts" type="text" class="input100" /></td>
    </tr>
    
    <tr>
      <td class="layertdleft100"><span class="psred">*</span>维修结果：</td>
      <td colspan="5" class="layerright" style="padding-bottom:2px;"><textarea style="height:50px;" name="fixFee.result"  class="textareaauto"></textarea></td>
    </tr>
    <tr>
      <td class="layertdleft100">整改意见：</td>
      <td colspan="5" class="layerright" style="padding-bottom:2px;"><label>
        <textarea name="fixFee.rectification" style="height:40px;" class="textareaauto"></textarea>
      </label></td>
    </tr>
    <tr>
      <td class="layertdleft100">备注：</td>
      <td colspan="5" class="layerright" style="padding-bottom:2px;"><label>
        <textarea name="fixFee.memo" style="height:40px;" class="textareaauto"></textarea>
      </label></td>
    </tr>
  </table>
</div>
