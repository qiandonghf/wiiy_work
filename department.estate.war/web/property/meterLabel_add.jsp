			...
			$('#form1').ajaxSubmit({ 
		        ...
		        success: function(data){
		        	...
		        	if(data.result.success){
		        		setTimeout("parent.fb.end();getOpener().reloadList('meter');", 2000);
		        	}
		        } 
		    });
		}
...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="layerright">	
      	 <enum:select type="com.wiiy.common.preferences.enums.MeterTypeEnum" name="meterLabel.type"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="layerright"  colspan="3">
      	   <%=EstateActivator.getSessionUser(request).getRealName()%>
      	   <input type="hidden" name="meterLabel.reader" value="<%=EstateActivator.getSessionUser(request).getRealName()%>"/>
      </td>
    </tr>
    <tr>
