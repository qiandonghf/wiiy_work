			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="layertdleft100">附件类型：</td>
       				<td class="layerright"><enum:select id="type" name="contractAtt.type" type="com.wiiy.common.preferences.enums.RoomAttTypeEnum" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="layerright"><textarea id="memo" name="contractAtt.memo" style="height:140px;resize:none;" class="inputauto"></textarea></td>
				</tr>
			</table>
		</div>
