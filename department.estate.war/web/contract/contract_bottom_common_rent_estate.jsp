...
%>
	...
	<input type="hidden" id="roomIds"/>
		<div class="emailtop">
			<div class="leftemail">
				<ul>
				<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_subjectRent_add")){ %>
...
<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_billPlanRent_list")){flag2++;%>
	<div class="basediv tabswitch" style="margin-top:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname" name="textname">
		<div class="emailtop">
			<div class="leftemail">
				<ul>
				<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_billPlanRent_add")){ %>
...
<%-- <%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_deposit_list")){flag2++;%>
	<div class="basediv tabswitch" style="margin-top:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname" name="textname">
		<div class="emailtop">
			<div class="leftemail">
				<ul>
				<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_deposit_add")){ %>
