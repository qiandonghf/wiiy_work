	...
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="layerright"><enum:select id="feeType" checked="result.value.feeType" type="com.wiiy.common.preferences.enums.EstateFeeEnum" name="billPlanRent.feeType"/></td>
			</tr>
			<tr>
