		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contractTemplate_chief")){%>
					content += "<img src=\"core/common/images/set_sys_icon2.gif\" width=\"14\" height=\"14\" title=\"设置主要打印模板\" onclick=\"chief('"+id+"');\"  /> "; 
					<%}%>
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contractTemplate_download")){%>
					content += "<img src=\"core/common/images/down.png\" width=\"14\" height=\"14\" title=\"下载\" onclick=\"downloadById('"+id+"');\"  /> "; 
					<%}%>
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contractTemplate_edit")){%>
					content += "<img src=\"core/common/images/edit.gif\" width=\"14\" height=\"14\" title=\"重命名\" onclick=\"editById('"+id+"');\"  /> "; 
					<%}%>
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contractTemplate_delete")){%>
...
<div class="emailtop">
	<div class="leftemail">
		<ul>
		<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contractTemplate_add")){%>
