...
<body>
	...
	<div class="basediv">
		<div class="emailtop">
			<div class="leftemail">
				<ul>
					...
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_approval_edit")){ %>
					...
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contract_print")){ %>
					...
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contract_execute")){ %>
					...
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contract_relet")){ %>
					...
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contract_subtract")){ %>
					...
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contract_surrender")){ %>
					...
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_contract_close")){ %>
		...
		<div class="divlays">
			<jsp:include page="contract_estate_view_common.jsp"></jsp:include>
