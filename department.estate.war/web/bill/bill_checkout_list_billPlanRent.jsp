...
<script type="text/javascript">
		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					<%}%>
					<%if(EstateActivator.getHttpSessionService().isInResourceMap("estate_billPlanRent_checkout")){%>
	...
	function initList2(){
		...
		$("#list2").jqGrid({
			url:'<%=basePath%>billPlanRent!list.action?statusType=outchecked',
			colModel: [
				{label:'ID', name:'id', align:"center",hidden:true}, 
				{label:'企业名称', name:'contract.customerName', align:"center"}, 
				{label:'费用类型', name:'feeType.title', align:"center",width:60}, 
									...
									<tbody>
										<tr>
											...
											<td width="90" style="padding-left: 3px;padding-right: 3px;">
												<search:choose dataType="com.wiiy.common.preferences.enums.EstateFeeEnum" field="feeType" op="eq">
												<enum:select type="com.wiiy.common.preferences.enums.EstateFeeEnum" styleClass="data"/>
												</search:choose>
											</td>
