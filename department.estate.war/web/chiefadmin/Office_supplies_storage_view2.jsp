		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
 		<tr>
	    	 <td class="layertdleft100" style="width:130px;">申请表名称：</td>
	     	 <td style="width:200px;">${result.value.supplyPurchaseForm.name}</td>
	    	 <td class="layertdleft100" style="width:130px;">申请人：</td>
	     	 <td style="width:200px;">${result.value.supplyPurchaseForm.requisitioner.realName}</td>
	     	 <td class="layertdleft100" style="width:130px;">申请时间：</td>
	     	 <td style="width:200px;"><fmt:formatDate value="${result.value.supplyPurchaseForm.applyTime}" pattern="yyyy-MM-dd"/></td>
    	</tr>
    	</table>	
	</div>
