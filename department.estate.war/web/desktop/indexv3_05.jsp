...
<script type="text/javascript">
	$(function(){
		//initProperty();
		//initComplaint();
		$("#estateContract").load("<%=BaseAction.rootLocation %>/department.estate/contract!estateDesktop.action");
	});
						...
						<ul>
							<li class="main2">
								<p class="text">
									...
									<span class="w300th"> 
									<a href="javascript:;" onclick="parent.addTab('所有报修','/department.estate/web/images/icon/projectadmin_02_min.png','<%=BaseAction.rootLocation%>/department.estate/web/property/property_repair_list.jsp');" class="huise">所有报修</a>
								...
								<p class="text">
									...
									<span class="w300th"> 
									<a href="javascript:;" onclick="parent.addTab('所有投诉','/department.estate/web/images/icon/projectadmin_02_min.png','<%=BaseAction.rootLocation%>/department.estate/web/property/complaint_list.jsp');" class="huise">所有投诉</a>
								...
								<p class="text">
									...
									<span class="w300th">
									<a href="javascript:;" onclick="parent.addTab('车辆管理','/department.estate/web/images/icon/projectadmin_02_min.png','<%=BaseAction.rootLocation%>/department.estate/web/property/vehicle_list.jsp');" class="huise">车辆管理</a> 
									<a href="javascript:;" onclick="parent.addTab('车位管理','/department.estate/web/images/icon/projectadmin_02_min.png','<%=BaseAction.rootLocation%>/department.estate/web/property/grage_list.jsp');" class="huise">车位管理</a> 
									</a></span>
								</p>
								<p class="text">
									<strong><a href="javascript:;" class="blue" style="text-decoration:none">库存管理</a></strong> 
									<span class="w300th">
										<a href="javascript:;" onclick="parent.addTab('所有入库','/department.estate/web/images/icon/projectadmin_02_min.png','<%=BaseAction.rootLocation%>/department.estate/web/chiefadmin/Office_supplies_storage_list.jsp');" class="huise">所有入库</a>
										...
										<a href="javascript:;" onclick="parent.addTab('所有出库','/department.estate/web/images/icon/projectadmin_02_min.png','<%=BaseAction.rootLocation%>/department.estate/web/chiefadmin/Office_supplies_sq.jsp');" class="huise">所有出库</a>
