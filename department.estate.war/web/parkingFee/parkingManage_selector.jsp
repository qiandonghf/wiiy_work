...
<script type="text/javascript">
	...
	function initList(){
		$("#list").jqGrid({
			...
			colModel: [
				...
				{label:'牌照', name:'licenseTag',width:80, align:"center"},
				{label:'车主姓名', name:'name',width:80, align:"center"},
				{label:'所在单位', name:'unit', align:"center",hidden:true},
				{label:'联系电话', name:'phone', hidden:true, align:"center",hidden:true},
				{label:'缴费情况', name:'payment', hidden:true, align:"center",hidden:true}
			],
			height: 235,
	...
	function submitSelectedParking() {
		try{
			if(typeof(getOpener().eval("setSelectedParking")) == "function"){
				var ids = $("#list").jqGrid("getDataIDs");
				$(ids).each(function (index, id) {
					if ($("#list").find('#'+id+' input').prop('checked')) {
						var rowData = $("#list").jqGrid("getRowData", id);
						
						getOpener().setSelectedParking(rowData);
						return;
					}
				});
			} 
...
<body>
				...
				<td valign="top">
						...
						<div class="searchdiv">
							<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="185"><search:input id="name" dataType="string" field="licenseNo" op="cn" inputClass="inputauto"/></td>
	...
	<div class="buttondiv">
		<input name="Submit" type="button" class="savebtn" value="" onclick="submitSelectedParking()"/>
