		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="layerright">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100"><input readonly="readonly" id="planPayDate" name="billPlanRent.planPayDate" value='<fmt:formatDate pattern="yyyy-MM-dd" value="${result.value.planPayDate}"/>' type="text" class="inputauto" onclick="return showCalendar('planPayDate')"/></td>
							...
							<td>&nbsp;</td>
							<td class="layerright">
								<label><input name="billPlanRent.audit" type="checkbox" <c:if test="${result.value.audit eq 'YES' }">checked="checked"</c:if> value="${result.value.audit }" onclick="changeState(this);" /><span>未审核</span></label>
							</td>
						</tr>
					</table>
				</td>
