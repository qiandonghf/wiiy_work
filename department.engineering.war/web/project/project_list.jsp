		...
		$("#list").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean add = EngineeringActivator.getHttpSessionService().isInResourceMap("department_engineering_project_add");
					boolean edit = EngineeringActivator.getHttpSessionService().isInResourceMap("department_engineering_project_edit");
					boolean view = EngineeringActivator.getHttpSessionService().isInResourceMap("department_engineering_project_view");
					boolean del = EngineeringActivator.getHttpSessionService().isInResourceMap("department_engineering_project_delete");%>
					<%if(view){%>
