		...
		$("#"+list).jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					...
					boolean edit = EngineeringActivator.getHttpSessionService().isInResourceMap("department_engineering_project_plan_edit");
					boolean view = EngineeringActivator.getHttpSessionService().isInResourceMap("department_engineering_project_plan_view");
					boolean del = EngineeringActivator.getHttpSessionService().isInResourceMap("department_engineering_project_plan_delete");%>
					<%if(view){%>
