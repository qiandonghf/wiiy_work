...
function getVariables(){
	...
	case "usertask1":
		...
		variables.keys= 'managerPass,leaderBackReason';
	...
	case "usertask2":
		...
		variables.keys= 'gmanagerPass,leaderBackReason';
		variables.values= true;
		variables.types= 'B,S';
		if(agree == 'false'){
			variables.values= false;
          ...
          <tr>
          	<td>
                  ...
                  <!--//basediv-->
           		...
           		<c:when test="${result.value.task.taskDefinitionKey eq 'usertask1' ||result.value.task.taskDefinitionKey eq 'usertask2'}">
