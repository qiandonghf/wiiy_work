...
function initForm(){
	$("#form1").validate({
		rules: {
			"contactform.department":"required",
			"contactform.sendTime":"required"
		},
		messages: {
			"contactform.department":"请填写发出部门",
			"contactform.sendTime":"请选择发出时间"
		},
...
<body>
<form action="<%=basePath %>contactform!save.action?type=contactinForm" method="post" name="form1" id="form1">
			...
			<div class="divlays" style="margin:0px;">
              <table id="insertTxt" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="layerright">
						<input id="department" name="contactForm.department" type="text"  class="inputauto"/>
					</td>
			      	...
			      	<td class="layerright" >
			      		<table width="143" border="0" cellspacing="0" cellpadding="0">
				        	<tbody>
					          <tr>
					            <td>
					            	<input id="sendTime" name="contactForm.sendTime" readonly="readonly" type="text" class="inputauto" onclick="showCalendar('sendTime')"/>
					            </td>
		       	...
		       	<tr>
			    	...
			    	<td class="layerright" colspan="3" style="padding-bottom:3px;">
			    		<textarea name="contactForm.affairs" class="inputauto" style="resize:none;height:40px;"></textarea>
			    	</td>
		       	</tr>
		       	<tr>
					<td colspan="4">
