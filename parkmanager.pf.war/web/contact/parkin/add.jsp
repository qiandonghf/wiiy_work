...
function initForm(){
	$("#form1").validate({
		rules: {
			"parkin.leaveType":"required",
			"parkin.startTime":"required",
			"parkin.endTime":"required"
		},
		messages: {
			"parkin.leaveType":"请选择请假类型",
			"parkin.startTime":"请选择开始时间",
			"parkin.endTime":"请选择结束时间"
		},
...
<body>
<form action="<%=basePath %>parkin!save.action" method="post" name="form1" id="form1">
         ...
         <div class="basediv" style="min-width:600px;">
			<div class="divlays" style="margin:0px;">
              <table id="insertTxt" width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td colspan="4">
						<div class="titlebg2" style="text-align:center;margin:1px 1px 0px 1px;"><strong>入孵申请单</strong></div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="layerright" style="padding:0px 3px;">
						<input id="projectName" name="parkin.projectName"  type="text" class="inputauto" /></td>
						
					<td class="layertdleft100">项目编号：</td>
					<td class="layerright">
						<input id="projectId" name="parkin.projectId"  type="text" class="inputauto" />
					</td>
				</tr>
