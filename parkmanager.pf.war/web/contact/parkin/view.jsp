					...
					<table width="97%" id="insertTxt" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;border: solid 1px #666666">
						<tr>
							<td colspan="4" class="noPadding">
								<div class="titlebg2" style="text-align:center;"><strong>入孵申请单</strong></div>
							</td>
						</tr>
						<tr> 
						...
						<tr>
							...
							<td class="layerright">
								<input readonly value="${result.value.projectId}" class="inputauto"/>
							</td>
							<td class="layertdleft100">项目名称：</td>
							<td class="layerright"><input readonly value="${result.value.projectName}" class="inputauto"/></td>
						</tr>
