...
<script type="text/javascript">
	...
	function loadCustomerLabel(){
		$.post("<%=BaseAction.rootLocation%>/parkmanager.pb/customerLabel!loadCustomerLabel.action",function(data){
	...
	function generateCode(){
		$.post("<%=BaseAction.rootLocation%>/parkmanager.pb/customer!generateCode.action",function(data){
		...
		$("#form1").validate({
			...
			submitHandler: function(form){
				if($(".incubated:checked").val()=='YES'){
					...
					if($("#incubationEndDate").val()!='' && $("#incubationEndDate").val()<$("#incubationStartDate").val()){
						tabSwitch('apptabli','apptabliover','tabswitch',3);
				...
				$('#form1').ajaxSubmit({ 
			        ...
			        success: function(data){
			        	...
			        	if(data.result.success){
			        		...
			        		getOpener().openContract(data.result.value.id);
...
<body>
<form action="<%=BaseAction.rootLocation%>/parkmanager.pb/customer!save.action" method="post" name="form1" id="form1">
	<input id="ids" name="ids" type="hidden"/>
	<input id="agreementName" name="incubationInfo.agreementName" type="hidden"/>
	<input type="hidden" name="customer.investmentId" value="${result.value.id }"/>
		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="35%" class="layerright"><input id="name" name="customer.name" readonly="readonly" type="text" class="inputauto" value="${result.value.name }" /></td>
				...
				<tr>
					...
					<td width="35%" class="layerright"><input id="shortName" name="customer.shortName" value="${result.value.account }" type="text" class="inputauto" /></td>
				...
				<tr>
					...
					<td class="layerright">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><input id="hostId" name="customer.hostId" value="${result.value.hostId }" type="hidden" class="inputauto" /><input id="hostName" name="customer.hostName" value="${result.value.hostName }" readonly="readonly" type="text" class="inputauto" onclick="selectUser(1)" /></td>
				...
				<tr>
					...
					<td class="layerright">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><input id="importId" name="customer.importId" value="${result.value.importId }" type="hidden" class="inputauto" /><input id="importName" value="${result.value.importName }" name="customer.importName" readonly="readonly" type="text" class="inputauto" onclick="selectUser(2)" /></td>
	...
	<div style="height:260px;">
		...
		<%} %>
		<%if(PfActivator.getHttpSessionService().isInResourceMap("pb_registerMessage_add")){ flag2++;%>
		<div class="basediv tabswitch" style="margin-top:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
			<div class="divlays" style="margin:0px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="35%" class="layerright">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><input id="regTime" name="customerInfo.regTime" readonly="readonly" value="<fmt:formatDate value="${result.value.regTime}" pattern="yyyy-MM-dd"/>" type="text" class="inputauto" onclick="return showCalendar('regTime');"/></td>
						...
						<td width="35%" class="layerright"><dd:select name="customerInfo.regTypeId" key="crm.0004" checked="result.value.regTypeId"/></td>
					</tr>
					<tr>
						<td class="layertdleft100">注册资本：</td>
						<td class="layerright"><input name="customerInfo.regCapital" value="<fmt:formatNumber value="${result.value.regCapital}" pattern="#0.00"/>" type="text" style="width:100px;" class="inputauto" /> 万元  <dd:select name="customerInfo.currencyTypeId" checked="result.value.currencyTypeId" key="crm.0005"/></td>
						<td class="layertdleft100">工商注册号：</td>
						<td class="layerright"><input name="customerInfo.businessNumber" value="${result.value.businessNumber}" type="text" class="inputauto" /></td>
					</tr>
					<tr>
						<td class="layertdleft100">组织机构代码：</td>
						<td class="layerright"><input name="customerInfo.organizationNumber" value="${result.value.organizationNumber}" type="text" class="inputauto" /></td>
						<td class="layertdleft100">法定代表人：</td>
						<td class="layerright"><input name="customerInfo.legalPerson" value="${result.value.legalPerson}" type="text" class="inputauto" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="layerright"><dd:select name="customerInfo.documentTypeId" key="crm.0006" checked="result.value.documentTypeId"/></td>
						<td class="layertdleft100">E-mail：</td>
						<td class="layerright"><input name="customerInfo.regMail" value="${result.value.regMail}" type="text" class="inputauto" /></td>
					</tr>
					<tr>
						<td class="layertdleft100">证件号：</td>
						<td class="layerright"><input name="customerInfo.documentNumber" value="${result.value.documentNumber}" type="text" class="inputauto" /></td>
						<td class="layertdleft100">移动电话：</td>
						<td class="layerright"><input name="customerInfo.cellphone" value="${result.value.cellphone}" type="text" class="inputauto" /></td>
					</tr>
					<tr>
						<td class="layertdleft100">注册地址：</td>
						<td class="layerright"><input name="customerInfo.regAddress" value="${result.value.regAddress}" type="text" class="inputauto" /></td>
						<td class="layertdleft100">营业截至日期：</td>
						<td class="layerright">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><input id="businessExpireDate" readonly="readonly" name="customerInfo.businessExpireDate" value="<fmt:formatDate value="${result.value.businessExpireDate}" pattern="yyyy-MM-dd"/>" type="text" class="inputauto" onclick="return showCalendar('businessExpireDate');"/></td>
		...
		<%} %>
		<%if(PfActivator.getHttpSessionService().isInResourceMap("pb_canvassMessage_add")){ flag2++;%>
		<div class="basediv tabswitch" style="margin-top:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
			<div class="divlays" style="margin:0px;">
		    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
		...
		<%} %>
		<%if(PfActivator.getHttpSessionService().isInResourceMap("pb_hatchMessage_add")){ flag2++;%>
		...
		<%} %>
		<%if(PfActivator.getHttpSessionService().isInResourceMap("pb_aptitude_add")){ flag2++;%>
		...
		<%} %>
		<%if(PfActivator.getHttpSessionService().isInResourceMap("pb_other_add")){ flag2++;%>
		<div class="basediv tabswitch" style="margin-top:0px;<%if(flag2!=0){ %>display:none;<%} %>">
			<div class="divlays" style="margin:0px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
