              ...
              <table id="insertTxt" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="layerright" style="padding:0px 3px;">
						<input id="investmentName" name="fictitious.investmentName" readonly="readonly" value="${investmentDto.name }" type="text" class="inputauto" />
						<input type="hidden" name="fictitious.investmentId" id="investmentId" value="${investmentDto.id }"/>
					</td>
				</tr>
				<tr>
					<td class="layertdleft100">法人代表：</td>
					<td class="layerright" style="padding:0px 3px;">
						<input id="legalPerson" name="fictitious.legalPerson" value="${investmentDto.legalPerson }" type="text" class="inputauto" />
					</td>
					<td class="layertdleft100">注册资本：</td>
					<td class="layerright" style="padding:0px 3px;">
						<input id="regCapital" name="fictitious.regCapital" value="${investmentDto.regCapital }"  type="text" class="inputauto" onkeyup="value=value.replace(/[^\d\.]/g,'');" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" class="layerright" style="padding:0px 3px;">
						<input id="managerAddress" name="fictitious.managerAddress" value="${investmentDto.address }"  type="text" class="inputauto" /></td>
				</tr>
				<tr>
					<td class="layertdleft100">企业经营范围及规模、优势、前景等情况介绍：</td>
					<td colspan="3" class="layerright" style="padding:0px 3px;">
						<textarea id="introduce" name="fictitious.introduce"  value="${investmentDto.businessScope }" class='inputauto' style='height:40px;resize: none;color:#666;'></textarea>
					</td>
				</tr>
				<tr>
