...
function getVariables(){
	...
	case "usertask2":
		...
		variables.keys= 'deptLeaderPass,leaderBackReason';
	...
	case "usertask3":
		...
		variables.keys= 'fgdirectorPass,leaderBackReason';
		variables.values= true;
		variables.types= 'B,S';
		if(agree == 'false'){
			variables.values= false;
	...
	case "usertask4":
		...
		variables.keys= 'zhdepart,leaderBackReason';
		variables.values= true;
		variables.types= 'B,S';
		if(!agree){
			variables.values= false;
	...
	case "modifyApply":
		...
		variables.types = 'B';
		variables.keys += ',investmentName';
		variables.values += ","+$('#investmentName').val();
		variables.types += ',S';
		variables.keys += ',investmentId';
		variables.values += ","+$('#investmentId').val();
		variables.types += ',S';
		break;
	}
	return true;
           		...
           		<div class="basediv" style="width: 340px;height: 100px;border: 1px solid #cbcbcb;margin-top: 5px;"> 
					...
					<!--titlebg-->
             		<div class="textremind">
						...
						<li class="remind"> <textarea id="reason" cols="45" rows="4" style="resize:none;">该企业符合现代服务型企业要求。经协商给予注册，房间号为 室。租期一年：    租金 元/年，押金 元。请领导审批</textarea></li>                  
						</ul>
					</div>
