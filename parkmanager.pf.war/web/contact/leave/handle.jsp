...
function getVariables(){
	...
	case "deptLeaderAudit":
		...
		break;
	case "hrAudit":
		variables.keys= 'hrPass,leaderBackReason';
		variables.values= true;
		variables.types= 'B,S';
		if(!agree){
			variables.values= false;
	...
	case "modifyApply":
		...
		variables.types = 'B';
		variables.keys += ',leaveType';
		variables.values += ","+$('#leaveType').val();
		variables.types += ',S';
		variables.keys += ',startTime';
		variables.values += ","+$('#startTime').val();
		variables.types += ',D';
		variables.keys += ',endTime';
		variables.values += ","+$('#endTime').val();
		variables.types += ',D';
		variables.keys += ',reason';
		variables.values += ","+$('#reason').val();
		variables.types += ',S';
		break;
	}
	return true;
          ...
          <tr>
          	<td>
                  ...
                  <!--//basediv-->
           		...
           		<c:when test="${result.value.task.taskDefinitionKey eq 'hrAudit' || result.value.task.taskDefinitionKey eq 'deptLeaderAudit'}">
