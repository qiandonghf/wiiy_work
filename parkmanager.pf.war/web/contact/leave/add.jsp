...
<body>
<form action="<%=basePath %>leave!save.action" method="post" name="form1" id="form1">
         ...
         <div class="basediv" style="min-width:600px;">
			<div class="divlays" style="margin:0px;">
              <table id="insertTxt" width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td colspan="4">
						<div class="titlebg2" style="text-align:center;margin:1px 1px 0px 1px;"><strong>请假申请单</strong></div>
					</td>
				</tr>
				<tr>
					...
					<td width="29%" class="layerright">
						<input name="leave.applyTime" disabled class="inputauto" value='默认为当前日期'/>
					</td>
				</tr>
				<tr>
					...
					<td class="layerright" style="padding:0px 3px;">
						<table width="100%">
							<tr>
								<td><input id="startTime" name="leave.startTime" readonly type="text" class="inputauto" onclick="showCalendar('startTime');"/></td>
								<td width="20"><img src="core/common/images/timeico.gif" width="20" height="22" onclick="showCalendar('startTime');" /></td>
							</tr>
						</table>
					</td>
					<td class="layertdleft100">请假类型：</td>
					<td class="layerright">
						<enum:select name="leave.leaveType" type="com.wiiy.pf.preferences.enums.LeaveTypeEnum" /> 
					</td>
				</tr>
				<tr>
					...
					<td class="layerright" style="padding:0px 3px;">
						<table width="100%">
							<tr>
								<td><input id="endTime" name="leave.endTime" readonly type="text" class="inputauto" onclick="showCalendar('endTime');"/></td>
								<td width="20"><img src="core/common/images/timeico.gif" width="20" height="22" onclick="showCalendar('endTime');" /></td>
							</tr>
						</table>
					</td>
					<td class="layertdleft100">共计：</td>
					<td class="layerright"><input name="" type="text" disabled class="inputauto" /></td>
				</tr>
				<tr>
					<td class="layertdleft100" width="29%">请假原因：</td>
					<td colspan="3" class="layerright" style="margin-bottom:2px;padding-right:5px;">
						<textarea name="leave.reason"  class="inputauto"  style="height:40px;resize: none;"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="4">
