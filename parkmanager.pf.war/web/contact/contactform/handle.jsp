...
function getVariables(){
	...
	case "usertask1":
		...
		variables.keys= 'directorPass,leaderBackReason';
	...
	case "usertask2":
		...
		variables.keys= 'yqOfficePass,leaderBackReason';
		variables.values= true;
		variables.types= 'B,S';
		if(agree == 'false'){
			variables.values= false;
	...
	case "usertask3":
		...
		variables.keys= 'zcOfficePass,leaderBackReason';
		variables.values= true;
		variables.types= 'B,S';
		if(agree == 'false'){
			variables.values= false;
	...
	case "usertask4":
		...
		variables.keys= 'president,leaderBackReason';
		variables.values= true;
		variables.types= 'B,S';
		if(!agree){
			variables.values= false;
