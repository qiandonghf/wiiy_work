...
function getVariables(){
	...
	case "deptLeaderAudit":
		...
		variables.keys= 'deptLeaderPass,deptLeaderBackReason';
	...
	case "cwLeaderAudit":
		...
		variables.keys= 'cwLeaderPass,cwLeaderReason';
		variables.values= true;
		variables.types= 'B,S';
		if(agree == 'false'){
			variables.values= false;
	...
	case "cwcnAudit":
		...
		$("input[name='bill.paid']").val('YES');
		if(agree == 'false'){
			$("input[name='bill.paid']").val('NO');
		}
		variables.keys= 'cwcnBackReason';
		variables.types= 'S';
		variables.values = leaderBackReason;
		break;
	case "modifyApply":
...
<input type="hidden" name="bill.paid" value="NO"/>
            ...
            <td>
                ...
                <div class="basediv" > 
                  ...
                  <div class="divlays reminds"> 
                    ...
                    <div id="attrs">
                    	<%-- <c:forEach items="${contactAttList }" var="attr">
	                    <div class="downlistprocess">
	                    	...
	                    	<input type="hidden" value="${attr.size }" />
							<ul>
		                        <li>${attr.oldName }</li>
		                        <li><a href="javascript:void(0)" onclick="downLoadFile('${attr.newName}','${attr.oldName}');">下载</a><!-- <a href="javascript:void(0)">打开</a> --><a href="javascript:;" onclick="deleteAttr(this,'${attr.id}');">删除</a></li>
	                      	</ul>
	                    </div>
	                    </c:forEach> --%>
                    </div>
          ...
          <tr>
          	<td>
                  ...
                  <!--//basediv-->
           		...
           		<c:when test="${(result.value.task.taskDefinitionKey eq 'deptLeaderAudit') 
           			|| (result.value.task.taskDefinitionKey eq 'cwLeaderAudit')}">
                  ...
                  <!--//basediv-->
           		...
           		<div class="basediv reminds3"> 
					...
					<div class="divlays"> 
						...
						<div style="margin:12px 5px 0px 10px;">
		           			<label>
		             			<input type="radio" name="agreement" value="true" checked/><span style="margin-left:2px;">已付款</span>
			             	</label>
			             	<label>
		             			<input type="radio" name="agreement" value="false" /><span style="margin-left:2px;">未付款</span>
			             	</label>
		             	</div>
          			</div>
          			<div class="textremind">
