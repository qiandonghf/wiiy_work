...
import com.wiiy.pf.system.DataDictInit;

public class PfActivator extends AbstractActivator {
	...
	public void startBundle(BundleContext context) throws Exception {
		...
		logger.debug("bundle 【parkmanager.wms.war】 start");
		//initProcess();
	}
				...
				public void serviceChanged(ServiceEvent serviceEvent) {
					if (serviceEvent.getType() == ServiceEvent.REGISTERED){
						...
						if (registeredService instanceof FKService) {
							...
							fkService.registryFK(getFKDescription(bundleContext,"WEB-INF/classes/com/wiiy/wms/entity/"));
						}
					}
				}
			});
	...
	public void stopBundle(BundleContext context) throws Exception {
		logger.debug("bundle 【parkmanager.wms.war】 stop");
	}
	...
	public static User getUserByHql(String hql){
		return getService(bundleContext, OsgiUserService.class).getByHql(hql);
	}
