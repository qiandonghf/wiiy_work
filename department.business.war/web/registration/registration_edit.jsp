  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
		...
		<td class="layerright" colspan="3">
			<input id="name" name="registrationBook.name" value="${result.value.name }" class="inputauto" />
		</td>
    </tr>
    <tr>
		...
		<td class="layerright">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<input id="contectInfoName" name="registrationBook.contectInfoName"  value="${result.value.contectInfoName }" class="inputauto" readonly="readonly" type="text" onclick="selectContectInfo();" />
						<input id="contectInfoId" name="registrationBook.contectInfoId" value="${result.value.contectInfoId }" type="hidden" class="inputauto" />
					</td>
		...
		<td class="layerright">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<input id="investmentId" name="registrationBook.investmentId" value="${result.value.investmentId }" type="hidden" class="inputauto" />
						<input id="investmentName" name="registrationBook.investmentName" value="${result.value.investmentName }" class="inputauto" readonly="readonly" type="text" onclick="selectInvestment();" />
					</td>
					<td width="25" align="center">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						...
						<input id="roomName" name="registrationBook.roomName" value="${result.value.roomName }"  readonly="readonly" type="text" class="inputauto" onclick="selectRoom();" />
					</td>
	...
	<tr>
      ...
      <td class="layerright">
      	  <enum:select checked="result.value.rentStatus" name="registrationBook.rentStatus" type="com.wiiy.business.preferences.enums.RentEnum" /> 
      </td>
