...
<script type="text/javascript">
	...
	function initList(){
		...
		boolean add = BusinessActivator.getHttpSessionService().isInResourceMap("registration_business_add");
		boolean edit = BusinessActivator.getHttpSessionService().isInResourceMap("registration_business_edit");
		boolean del = BusinessActivator.getHttpSessionService().isInResourceMap("registration_business_delete");
		boolean view = BusinessActivator.getHttpSessionService().isInResourceMap("registration_business_view");
		boolean status = BusinessActivator.getHttpSessionService().isInResourceMap("registration_business_changeState");
		%>
		<%if(add || del){ %>
		...
		$("#list").jqGrid({
	    	url:'<%=basePath%>registrationBook!list.action?type=${param.type}',
	    	colModel: [
	...
	function viewById(id){
		fbStart('查看','<%=basePath%>registrationBook!view.action?id='+id,620,412);
	}	
	function editById(id){
		fbStart('编辑','<%=basePath%>registrationBook!edit.action?id='+id,620,360);
	}
	...
	function add(){
		fbStart('新建','<%=basePath %>web/registration/registration_add.jsp',620,360);
	}
	function doSearch(){
