...
<div class="divlays" style="margin:0px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="layerright">
      	<dd:select id="positionId" name="staffer.positionId" key="business.0014" checked="result.value.positionId"/>
      </td>
    </tr>
    <tr>
      <td class="layertdleft100">政治面貌：</td>
      <td class="layerright">
      	<dd:select id="politicalId" name="staffer.politicalId" key="business.0029" checked="result.value.politicalId"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="layerright">
      	<dd:select id="degreeId" name="staffer.degreeId" key="business.0015" checked="result.value.degreeId"/>
      </td>
    </tr>
    <tr>
