...
if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_customerMessage_view")){flag2++;%>					
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_registerMessage_view")){flag2++; %>
					<div class="basediv tabswitch" style="margin:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
						<div class="divlays" style="margin:0px;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_canvassMessage_view")){flag2++; %>
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_hatchMessage_view")){flag2++; %>
					<div class="basediv tabswitch" style="margin:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
						<div class="divlays" style="margin:0px;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_aptitude_view")){flag2++; %>
					<div class="basediv tabswitch" style="margin:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
						<div class="divlays" style="margin:0px;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_changeMessage_view")){flag2++; %>
					<div class="basediv tabswitch" style="margin:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
						<div class="emailtop">
							<div class="leftemail">
								<ul>
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_policyMessage_view")){flag2++; %>
					<div class="basediv tabswitch" style="margin:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
						<%if(BusinessActivator.getSessionUser(request).getUserType().equals(UserTypeEnum.Center)){ %>
						<div class="emailtop">
							<div class="leftemail">
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_accountMessage_view")){flag2++; %>
					<div class="basediv tabswitch" style="margin:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
					...
					<%} %>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("ps_other_view")){flag2++; %>
					<div class="basediv tabswitch" style="margin:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
						<div class="divlays" style="margin:0px;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
