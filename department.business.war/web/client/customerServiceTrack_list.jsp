				...
				<div class="pm_msglist" id="investRight_height3" style="overflow-y:auto;overflow-x:hidden;">
					<div>
						<div class="emailtop" style="border: 1px solid #D9D9D9; background: #f6f6f6;">
							...
							<div class="leftemail">
								<ul>
								<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_customerServiceTrack_add")){ %>
									<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('添加服务轨迹','<%=basePath %>web/client/customerServiceTrack_add.jsp?serviceId=${param.id }',450,185);" class="" style="border-color: #f6f6f6;"><span><img src="core/common/images/emailadd.gif"/></span>添加</li>
								<%} %>
								</ul>
							</div>
							<!--//leftemail-->
