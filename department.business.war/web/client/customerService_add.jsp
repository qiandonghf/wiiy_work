			        ...
			        success: function(data){
			        	...
			        	if(data.result.success){
			        		...
			        		if(type == 'index'){
			        			...
			        			var url = "<%=BaseAction.rootLocation%>/department.business/customerService!list.action";
		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<input id=serviceName name="customerService.serviceName" type="text" class="inputauto" />
					</td>
				</tr>
				<tr>
					...
					<td class="layerright">
						<dd:select key="business.0024" name="customerService.typeId"/>
            		</td>
				</tr>
				<tr>
				 ...
				 <tr>
				 	...
				 	<td class="layerright"><%=BusinessActivator.getSessionUser(request).getRealName()%>
			          	<input type="hidden" name="customerService.userId" value="<%=BusinessActivator.getSessionUser(request).getId()%>"/>
			        </td>
			 	</tr>
			 	<tr>
