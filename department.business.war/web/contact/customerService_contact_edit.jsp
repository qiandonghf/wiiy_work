		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="layerright">
						<dd:select key="business.0024" name="customerServiceContact.typeId" checked="result.value.typeId"/>
            		</td>
				</tr>
				<tr>
			 	...
			 	<tr>
			 		...
			 		<td width="30%" class="layerright">
			 			<enum:select type="com.wiiy.business.preferences.enums.CustomerServiceStatusEnum" name="customerServiceContact.status" checked="result.value.status"/>
					</td>
				</tr>
				<tr>
					<td class="layertdleft100">服务结果：</td>
			 		<td class="layerright">
			 			<enum:select type="com.wiiy.business.preferences.enums.CustomerServiceResultEnum" name="customerServiceContact.result" checked="result.value.result"/>
				 	</td>
				</tr>
			 	<tr>
