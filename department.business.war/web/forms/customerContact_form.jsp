...
<script type="text/javascript">
	 function selectedYear(){
		...
		location.href="<%=basePath%>contect!listByCustomerContact.action?yearNo="+yearNo+"&monthNo="+monthNo;
	}
...
<div id="overflowAuto">
	...
	<h2 style="text-align:center; font-size:18px; font-family:verdana,arial,sans-serif; ">客户联系方式</h2>
