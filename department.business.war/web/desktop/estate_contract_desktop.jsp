...
<ul>
	...
	<li>
		...
		<p class="text">
			<strong>
				<a href="javascript:;" class="blue" style="text-decoration:none">提醒</a>
			</strong> 
			<span>
				<a href="javascript:;" class="underline  huise">合同到期(<font>N</font>)</a> （默认为30天）
				<a href="javascript:;" class="huise underline ">到期房源(<font>N</font>)</a>
			</span>
		</p>
	</li>
</ul>
