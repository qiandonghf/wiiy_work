...
<script type="text/javascript">
	...
	function onUploadSuccess(file, data, response) {
		...
		$("#imageList").append($("<td width='60'><img src='core/resources/"+$.parseJSON(data).path+"' width='50' height='50'/></td>"));
...
<body>
<form action="<%=basePath %>projectLib!save.action" method="post" name="form1" id="form1">
<!--table切换开始-->
<div class="apptab" id="tableid">
    <ul>
    <%if(BusinessActivator.getHttpSessionService().isInResourceMap("customer_customrInfo_archives_OnePage_add_base")){%>
        <li class="apptabliover" onclick="tabSwitch('apptabli','apptabliover','tabswitch',0)">基本信息</li>
	<%} %>
    <%if(BusinessActivator.getHttpSessionService().isInResourceMap("customer_customrInfo_archives_OnePage_add_question")){%>
        <li class="apptabli" onclick="tabSwitch('apptabli','apptabliover','tabswitch',1)">问题</li>
	<%} %>
    <%if(BusinessActivator.getHttpSessionService().isInResourceMap("customer_customrInfo_archives_OnePage_add_condition")){%>
        <li class="apptabli" onclick="tabSwitch('apptabli','apptabliover','tabswitch',2)">财务状况</li>
	<%} %>
    </ul>
</div>
<!--//table切换开始-->
<div class="basediv tabswitch" style="margin-top:0px; height:440px;overflow-X:hidden; padding:0px 10px;" id="textname">
	    ...
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td ><input id="customerId" value="" name="projectLib.customerId" type="hidden" /><input id="customerName" name="projectLib.customerName" value="" type="text" class="inputauto" /></td>
          ...
          <tr>
          	<td class="assoction_td" style="padding-top: 5px;">地址：</td>
          	<td class="layerright"><input id="address" name="projectLib.address" type="text" class="inputauto" /></td>
          </tr>
        </table></td>
    </tr>
    <tr>
    	<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td class="assoction_td" style="padding-top: 5px;" style="padding-top:5px;">编号：</td>
	        <td class="layerright"><input id="orderId" name="projectLib.orderId" type="text" class="inputauto" /></td>
          </tr>
        </table></td>
    </tr>
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td class="assoction_td" style="padding-top: 5px;">网址：</td>
	        <td class="layerright"><input name="projectLib.homePage"  type="text" class="inputauto" /></td>
	        <td class="assoction_td" style="padding-top: 5px;" style="padding-top:5px;"><span class="psred" >*</span>城市：</td>
	        <td class="layerright"><label for="select">
	          <dd:select id="cityId" name="projectLib.cityId" key="business.0034"/>
	          </label></td>
	          <td></td>
          </tr>
	      <tr>
	        <td class="assoction_td" style="padding-top: 5px;"><span class="psred">*</span>联系电话：</td>
	        <td class="layerright"><input id="phone" name="projectLib.phone" type="text" class="inputauto" /></td>
	        <td class="assoction_td" style="padding-top: 5px;">邮编：</td>
	        <td class="layerright"><input id="zipCode" name="projectLib.zipCode"  type="text" class="inputauto" /></td>
          </tr>
          <tr>
		      <td class="assoction_td" style="padding-top: 5px;">LOGO：</td>
		      <td class="layerright">
		      <table border="0" cellspacing="0" cellpadding="0">
		      <tr>
		      <td height="60"  style="padding-right:10px;"> <input type="file" id="fileUpload" /> <div id="fileQueue"></div> </td>
		      <td>
			      <table  border="0" cellspacing="0" cellpadding="0">
			      	<tr id="imageList"></tr>
			      </table>
			      <input type="hidden" id="photos" name="projectLib.logo" />
		      </td>
		      </tr>
		      </table>
		      </td>
	  ...
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <input id="leaders" type="hidden" name="projectLib.leaders"/>
	      <tr>
	        <td class="assoction_td" style="padding-top: 5px;">负责人1：</td>
	        <td width="150"><input id="leader1" type="text" class="inputauto" /></td>
	        <td class="assoction_td" style="padding-top: 5px;">职务1：</td>
	        <td><input type="text" id="position1" class="inputauto" style=" width:126px;" /></td>
          </tr>
	      <tr>
	        <td class="assoction_td" >负责人2：</td>
	        <td width="150"><input type="text" id="leader2" class="inputauto"/></td>
	        <td class="assoction_td" >职务2：</td>
	        <td><input type="text" id="position2" class="inputauto" style=" width:126px;" /></td>
          </tr>
	      <tr>
	        <td class="assoction_td">负责人3：</td>
	        <td width="150"><input type="text" id="leader3" class="inputauto"/></td>
	        <td class="assoction_td">职务3：</td>
	        <td><input type="text" id="position3" class="inputauto" style=" width:126px;" /></td>
          </tr>
        </table></td>
    </tr>
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td width="152px" ><table border="0" cellspacing="0" cellpadding="0">
		        <tr>
		          <td width="132" ><input name="projectLib.setupTime" readonly="readonly" type="text" class="inputauto" id="setupTime" onclick="return showCalendar('setupTime');" /></td>
	        ...
	        <td ><table border="0" cellspacing="0" cellpadding="0">
	          <tr>
	            <td width="124" ><input name="projectLib.employeeCnt" type="text" class="inputauto" /></td>
	      ...
	      <tr>
	        ...
	        <td colspan="3"><label for="textarea"></label>
	          <table width="100%" border="0" cellspacing="0" cellpadding="0">
	            <tr>
	              <td><textarea name="projectLib.companyMemo" rows="3" class="textareaauto" id="textarea"></textarea></td>
                </tr>
	            <tr>
	  ...
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td width="150"><input id="name" name="projectLib.name" type="text" class="inputauto" /></td>
            <td class="assoction_td">项目来源：</td>
            <td ><input  id="incubatorName" name="projectLib.incubatorName" type="text" class="input100" /></td>
          </tr>
        </table></td>
    </tr>
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td width="150">
	            <input id="amout" name="projectLib.amount" type="text" class="input100" onkeyup="value=value.replace(/[^\d\.]/g,'')" />&nbsp;万元
            </td>
	        <td class="assoction_td" style="padding-top: 5px;">融资期限：</td>
	        <td><table border="0" cellspacing="0" cellpadding="10">
	          <tr>
		          <td width="126"><input name="projectLib.endTime" readonly="readonly" type="text" class="inputauto" id="endTime" onclick="return showCalendar('endTime');" /></td>
	  ...
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td>
				<dd:select id="industryId" name="projectLib.industryId" key="business.0035" />
			</td>
	        <td></td>
          </tr>
	      <tr>
	        ...
	        <td>
	        	<enum:select id="status" name="projectLib.status" type="com.wiiy.business.preferences.enums.ProjectStatusEnum"/>
	        </td>
	        <td></td>
          </tr>
        </table></td>
...
<div class="basediv tabswitch" style="margin-top:0px; height:430px;overflow-X:hidden; overflow-Y:scroll; padding:0px 10px;display: none;" id="textname">
    <input id="questionMemo" type="hidden" name="projectLib.questionMemo"/>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">团队优势：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">客户需求：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">目标市场及&nbsp;&nbsp;<br />
        潜在市场：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">潜在客户：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">市场战略：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">商业模式、<br />
        盈利模式：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">公司竞争力及&nbsp;&nbsp;<br />
        主要竞争对手：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
      ...
      <tr>
        <td valign="top" class="assoction_td" style="padding-top: 5px;">竞争优势及&nbsp;&nbsp;<br />市场进入简况：</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td style="padding-top:15px;"><label for="select3"></label>
	        	<enum:select id="gainStatus" name="projectLib.gainStatus" type="com.wiiy.business.preferences.enums.ProjectGainStatusEnum"/>
	        </td>
          </tr>
        </table></td>
  </tr>
  <tr>
    ...
    <input id="gainMemo" type="hidden" name="projectLib.gainMemo"/>
  </tr>
  <tr>
    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="3">
      	<tr>
	        <td class="assoction_td">&nbsp;</td>
		...
		<c:forEach items="${years}" var="year" varStatus="status">
			<tr>
				<td class="assoction_td">${year}年<input id="year${status.index}" value="${year}" type="hidden"/></td>
