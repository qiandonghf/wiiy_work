...
<script>
	...
	function viewById(id){
		fbStart($("#list").getRowData(id)["customer.name"],'<%=basePath %>bill!view.action?id='+id,550,360);
	}
			...
			<tr>
				...
				<td width="100%" valign="top">
					<div class="emailtop">
						<div class="leftemail">
							<ul>
							<%if(BusinessActivator.getHttpSessionService().isInResourceMap("pb_bill_inInform")){ %>
							...
							<%} %>
							<%if(BusinessActivator.getHttpSessionService().isInResourceMap("pb_bill_inInform")){ %>
								<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('联合开票','<%=basePath%>bill!inInformList.action',800,600);"><span><img src="core/common/images/bill_03.gif"/></span>联合开票</li>
							<%} %>
							</ul>
						</div>
					</div>
