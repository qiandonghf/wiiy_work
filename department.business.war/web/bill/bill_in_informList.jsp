...
系统检测到现有${customerTotal}个企业共计${billTotal}条帐单需缴费处理，其中${urgedTotal}条帐单已催缴，选择催缴范围与催缴方式实现催缴操作。如需打印催缴通知单，则进入&nbsp;<a href="javascript:void(0)" title=""  onclick="fbStart('收款','<%=basePath%>bill!billIn.action',700,370);">收款结算</a>&nbsp;页面。</div>
