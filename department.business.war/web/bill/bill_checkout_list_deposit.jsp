									...
									<tbody>
										<tr>
											...
											<td width="90" style="padding-left: 3px;padding-right: 3px;">
												<search:choose dataType="com.wiiy.crm.preferences.enums.BusinessFeeEnum" field="feeType" op="eq">
												<enum:select type="com.wiiy.crm.preferences.enums.BusinessFeeEnum" styleClass="data"/>
												</search:choose>
											</td>
