	...
	<div id="container">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<%
				...
				String billInfo = "";
				if(BusinessActivator.getAppConfig().getConfig("billInfo")!=null){
					billInfo = BusinessActivator.getAppConfig().getConfig("billInfo").getParameter("name");
				}else{
			...
			<!--//agencylist-->
				...
				<td width="100%" valign="top">
					...
					String userType = BusinessActivator.getSessionUser().getUserType().getTitle();
