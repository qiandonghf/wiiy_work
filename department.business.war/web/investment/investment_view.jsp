				...
				<div class="leftemail">
					<ul>
					 <%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_project_allEdit")){ %>
						<li onmouseover="this.className='libg'" onmouseout="this.className=''"  onclick="fbStart('编辑申请单','<%=basePath%>investment!edit.action?id=${result.value.id}',720,538);"><span><img src="core/common/images/edit.gif" /></span>编辑</li>
					 <%}%>
