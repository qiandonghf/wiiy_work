				...
				<div class="divlays" style="margin:0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="layerright"><enum:select type="com.wiiy.business.preferences.enums.ApprovalEnum" name="investment.chiefApprovalState" checked="result.value.chiefApprovalState"/></td>
						</tr>
						<tr>
