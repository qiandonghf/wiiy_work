					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="layerright" >
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="35"><input id="hostId" name="investment.hostId" type="hidden" class="inputauto" /><input id="hostName" name="investment.hostName" readonly="readonly" type="text" class="inputauto" onclick="selectUser(1)" value="<%=BusinessActivator.getSessionUser(request).getRealName() %>"/></td>
							...
							<td class="layerright" >
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="35"><input id="importId" name="investment.importId" type="hidden" class="inputauto" /><input id="importName" name="investment.importName" readonly="readonly" type="text" class="inputauto" onclick="selectUser(2)" value="<%=BusinessActivator.getSessionUser(request).getRealName() %>" /></td>
			...
			<div style="height:205px;">
				...
				<div class="basediv tabswitch" style="margin-top:0px; display:none;" name="textname" id="textname">
					<div class="emailtop">
						<div class="leftemail">
							<ul>
								<li onmouseover="this.className='libg'" onmouseout="this.className=''" onclick="fbStart('投资人信息','<%=basePath %>web/investment/investmentInvestor_add.jsp?investmentId='+$('#investmentId').val(),450,220);"><span><img src="core/common/images/emailadd.gif" /></span>添加</li>
