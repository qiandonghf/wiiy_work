	...
	function initForm(){
		$("#form1").validate({
			rules: {
				...
				"customerInfo.businessScope":"required",
			...
			messages: {
				...
				"customerInfo.businessScope":"请输入经营范围",
		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="layerright"><enum:select id="type" name="customer.type" type="com.wiiy.business.preferences.enums.CustomerTypeEnum"/></td>
					<td class="layertdleft100"><span class="psred">*</span>跟踪人：</td>
					<td class="layerright">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><input id="hostId" name="customer.hostId" value="${result.value.hostId }" type="hidden" class="inputauto" /><input id="hostName" value="${result.value.hostName }" name="customer.hostName" readonly="readonly" type="text" class="inputauto" onclick="selectUser(1)" /></td>
				...
				<tr>
					...
					<td class="layerright">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><input id="importId" name="customer.importId" value="${result.value.importId }" type="hidden" class="inputauto" /><input id="importName" name="customer.importName" value="${result.value.importName }" readonly="readonly" type="text" class="inputauto" onclick="selectUser(2)" /></td>
		...
		<div class="basediv tabswitch" style="margin-top:0px;<%if(flag2!=0){ %>display:none;<%} %>" id="textname">
			<div class="divlays" style="margin:0px;">
		    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="layertdleft100"><span class="psred">*</span>经营范围：</td>
						<td colspan="3" class="layerright">
