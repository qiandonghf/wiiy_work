...
<%@page import="com.wiiy.business.preferences.enums.SettleEnum"%>
<%
		...
		<div class="divlays" style="margin:0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" >
				...
				<td class="layertdleft100">房屋产权证号：</td>
	      		<td  class="layerright">
	      			<dd:select name="contract.propertyNo" key="business.0036" checked="result.value.propertyNoId" />
		    	</td>
			...
			<td class="layertdleft100">首期金额：</td>
	     	...
	     	<td class="layertdleft100">结算方式：</td>
      		<td class="layerright" >
      		<input style="border:0" type="com.wiiy.business.preferences.enums.SettleEnum" name="contract.payType" value="${result.value.payType.title}" readonly="readonly"/>
      		</td>
		      	</tr>
				<tr>
