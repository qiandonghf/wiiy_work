				...
				<tr>
					...
					<td class="layerright" width="270">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
							 <td id="xnId">XN</td>
							 <td width="165" style="padding-right: 5px"><input name="contract.code" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" id="code" type="text" value="${result.value.code}"   style="width: 165px;" class="inputauto"/></td>
