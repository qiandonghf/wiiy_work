		...
		$("#contractAttList").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractAtt_download")){%>
					content += "<img src=\"core/common/images/down.png\" width=\"14\" height=\"14\" title=\"下载\" onclick=\"downloadContractAttById('"+id+"');\"  /> "; 
					<%}%>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractAtt_edit")){%>
					content += "<img src=\"core/common/images/edit.gif\" width=\"14\" height=\"14\" title=\"编辑\" onclick=\"editContractAttById('"+id+"');\"  /> "; 
					<%}%>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractAtt_delete")){%>
		...
		$("#contractMemoList").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractMemo_view")){%>
					content += "<img src=\"core/common/images/viewbtn.gif\" width=\"14\" height=\"14\" title=\"查看\" onclick=\"viewContractMemoById('"+id+"');\"  /> "; 
					<%}%>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractMemo_edit")){%>
					content += "<img src=\"core/common/images/edit.gif\" width=\"14\" height=\"14\" title=\"编辑\" onclick=\"editContractMemoById('"+id+"');\"  /> "; 
					<%}%>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractMemo_delete")){%>
		...
		$("#contractApprovalList").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_approval_view")){%>
					content += "<img src=\"core/common/images/viewbtn.gif\" width=\"14\" height=\"14\" title=\"查看\" onclick=\"viewContractApprovalById('"+id+"');\"  /> "; 
					<%}%>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_approval_delete")){%>
		...
		$("#contractModifyList").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i = 0 ; i < ids.length; i++){
					var id = ids[i];
					var content = "";
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractModifyLog_view")){%>
					content += "<img src=\"core/common/images/viewbtn.gif\" width=\"14\" height=\"14\" title=\"查看\" onclick=\"viewContractModifyById('"+id+"');\"  /> "; 
					<%}%>
					<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractModifyLog_delete")){%>
...
<%int flag3=-1;
	if(BusinessActivator.getHttpSessionService().isInResourceMap("business_subjectRent_list")){
		flag3++;
	}
	if(BusinessActivator.getHttpSessionService().isInResourceMap("business_billPlanRent_list")){
		flag3++;
	}
	if(BusinessActivator.getHttpSessionService().isInResourceMap("business_deposit_list")){
		flag3++;
	}
%>
<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractAtt_list")){flag3++; %>

	<div class="basediv tabswitch" style="margin-top:0px;<%if(flag3!=0){ %>display:none;<%} %>" id="textname" name="textname">
		<div class="emailtop">
			<div class="leftemail">
				<ul>
				<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractAtt_add")){ %>
...
<%} %>
<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractMemo_list")){flag3++; %>
	<div class="basediv tabswitch" style="margin-top:0px;<%if(flag3!=0){ %>display:none;<%} %>" id="textname" name="textname">
		<div class="emailtop">
			<div class="leftemail">
				<ul>
				<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractMemo_add")){ %>
...
<%} %>
<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_approval_list")){flag3++; %>
	<div class="basediv tabswitch" style="margin-top:0px;<%if(flag3!=0){ %>display:none;<%} %>" id="textname" name="textname">
...
<%} %>
<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_contractModifyLog_list")){flag3++; %>
	<div class="basediv tabswitch" style="margin-top:0px;<%if(flag3!=0){ %>display:none;<%} %>" id="textname" name="textname">
		<table id="contractModifyList"><tr><td></td></tr></table>
	</div>
<%} %>
<%if(BusinessActivator.getHttpSessionService().isInResourceMap("business_favorable")){flag3++; %>
	<div class="basediv tabswitch" style="margin-top:0px;<%if(flag3!=0){ %>display:none;<%} %>" id="textname" name="textname">
