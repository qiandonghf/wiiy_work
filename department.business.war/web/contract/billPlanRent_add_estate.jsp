	...
	<div class="divlays" style="margin:0px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="layerright"><enum:select id="feeType" type="com.wiiy.common.preferences.enums.EstateFeeEnum" name="billPlanRent.feeType"/></td>
			</tr>
			<tr>
			...
			<%-- <tr>
				...
				<td class="layerright">
					<enum:select type="com.wiiy.business.preferences.enums.BillPlanStatusEnum" defaultValue="UNCHECK" name="billPlanRent.status"/>
				</td>
			</tr> --%>
			<tr>
				<td class="layertdleft100">备注：</td>
				<td class="layerright"><textarea name="billPlanRent.memo" class="inputauto" style="height:50px;resize:none;"></textarea></td>
			</tr>
		</table>
	</div>
