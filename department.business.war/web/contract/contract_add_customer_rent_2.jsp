...
<div class="basediv" style="margin-top:0px; height:500px; overflow:hidden; margin-top:3px;">
<div id="scrollDiv" style=" overflow-x:hidden;  height:500px; overflow-y:scroll; position:relative;">
<div class="basediv">
      		...
      		<td class="layerright" width="33%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	            <tbody>
		            ...
		            <!-- <td style="padding-right: 2px">
		            		<select id="contractModel" style="height: 22px"></select>
		            </td> -->
       		...
       		<!-- <td class="layertdleft100">待交付时间：</td>
	      	<td class="layerright"><table width="147" border="0" cellspacing="0" cellpadding="0">
	        	<tbody>
		          <tr>
...
<%-- 			<td class="layertdleft100">租金支付方式：</td>
			<td class="layerright">
				<enum:select type="com.wiiy.business.preferences.enums.RentBillPlanEnum" name="contract.payType"/>
			</td>
 --%>		<td class="layertdleft100"><span class="psred">*</span>签订日期：</td>
    	...
    	<tr>
	    	...
	    	<td colspan="3" class="layerright"><textarea name="contract.rentAmount" rows="2" class="textareaauto"></textarea></td>
	    </tr>
  </table>
  </div>
<div class="hackbox"></div>
