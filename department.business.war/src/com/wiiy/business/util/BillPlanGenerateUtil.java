...
//		testPlanDate();
	...
	public static void test(){
		...
		List<BusinessBillPlanRent> list = generate(rentBillPlan, billingMethod, startDate, endDate, roomArea, price, priceUnit).getValue();
		if(list!=null)
...
//			System.out.print("计划付费时间："+DateUtil.format(billPlanRent.getPlanPayDate()));
	...
	public static Result<List<BusinessBillPlanRent>> generate(RentBillPlanEnum rentBillPlan, BillingMethodEnum billingMethod, Date startDate, Date endDate, Double roomArea, Double price, PriceUnitEnum priceUnit) {
	 ...
	 * @return
	 */
	public static Result<List<BusinessBillPlanRent>> generate(RentBillPlanEnum rentBillPlan, BillingMethodEnum billingMethod, Date startDate, Date endDate, Double roomArea, Double price, PriceUnitEnum priceUnit,Double customPrice) {
		List<BusinessBillPlanRent> list = new ArrayList<BusinessBillPlanRent>();
	...
	private static List<BusinessBillPlanRent> generateMonthDay(Date startDate, Date endDate,Double roomArea, Double price, RentBillPlanEnum rentBillPlan){
		List<BusinessBillPlanRent> list = new ArrayList<BusinessBillPlanRent>();
	...
	private static List<BusinessBillPlanRent> generateMonthMonth(Date startDate, Date endDate,Double roomArea, Double price,int months, RentBillPlanEnum rentBillPlan){
		List<BusinessBillPlanRent> list = new ArrayList<BusinessBillPlanRent>();
		List<PlanDate> dateList = generatePlanDate(startDate, endDate, rentBillPlan);
		for (PlanDate planDate : dateList) {
	...
	private static List<BusinessBillPlanRent> generateDateMonthDay(Date startDate, Date endDate,Double roomArea, Double price, RentBillPlanEnum rentBillPlan){
		List<BusinessBillPlanRent> list = new ArrayList<BusinessBillPlanRent>();
		List<PlanDate> dateList = generatePlanDate(startDate, endDate, rentBillPlan);
		for (PlanDate planDate : dateList) {
	...
	private static BusinessBillPlanRent createBillPlanRent(Date startDate, Date endDate, Double planFee){
