 ...
 */
public class BusinessBillPlanRent extends BaseEntity implements Serializable {
	/** 
	 * 
	 */ 
	private static final long serialVersionUID = 1L;
	public BusinessBillPlanRent() {
		super();
	}
	public BusinessBillPlanRent(Double realFee, Date planPayDate,
	 ...
	 */
	@FieldDescription("标的")
	private BusinessSubjectRent subject;
	/**
	 * 合同外键
	 */
	 ...
	 * 标的
	 */
	public BusinessSubjectRent getSubject(){
		return subject;
	}
	public void setSubject(BusinessSubjectRent subject){
