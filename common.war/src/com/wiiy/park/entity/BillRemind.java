...
/**
 * <br/>class-description 账单催缴
 * <br/>extends com.wiiy.commons.entity.BaseEntity
 */
public class BillRemind extends BaseEntity implements Serializable {
	/** 
	 * 
	 */ 
	...
	public BillRemind(Long id, Date planPayTime) {
		super();
		this.id = id;
		this.planPayTime = planPayTime;
	}
	
	public BillRemind(Long id, Long billTypeId, Long customerId,Double factPayment,Date createTime) {
		super();
		this.id = id;
	 ...
	 * 催缴状态
	 */
	@FieldDescription("催缴状态")
	private BillRemindStatusEnum remindStatus;
	/**
	 * 备注
	 */
	@FieldDescription("备注")
	...
	public BillRemindStatusEnum getRemindStatus() {
		return remindStatus;
	}
	public void setRemindStatus(BillRemindStatusEnum remindStatus) {
