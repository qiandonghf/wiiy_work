	...
	<div class="basediv">
		...
		<div style="margin:0 4px; border:1px solid #ccc;">
		    <table border="1" bordercolor="#ccc" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
		        ...
		        <c:forEach items="${result.value.billTypeDto }" var="dto">
			        <tr>
			           <td align="center">${dto.typeName}</td>
			           <td align="center"><fmt:formatDate value="${dto.feeStartTime}" pattern="yyyy-MM-dd"/> – <fmt:formatDate value="${dto.feeEndTime}" pattern="yyyy-MM-dd"/></td>
			           <td align="center"><fmt:formatDate value="${dto.checkoutTime}" pattern="yyyy-MM-dd"/></td>
			           <td align="right"><fmt:formatNumber value="${dto.money}" pattern="#0.00"/></td>
			        </tr>
		        </c:forEach>
		        <tr>
