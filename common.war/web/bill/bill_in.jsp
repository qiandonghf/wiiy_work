...
<body>
	...
	<search:choose dataType="com.wiiy.common.preferences.enums.BillStatusEnum"
		field="status" op="eq">
							...
							<tr>
								<td><search:choose dataType="long" field="customerId"
										...
										<input type="hidden" id="customerId" class="data"
											value="${param.id }" />
									</search:choose> <search:choose dataType="string" field="customerName" op="cn">
								...
								<td width="20" align="center"><img
									...
									onclick="fbStart('选择企业','<%=BaseAction.rootLocation%>/department.business/customer!select.action',520,400);"
