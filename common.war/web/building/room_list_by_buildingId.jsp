...
function initList(list){
	...
	$("#"+list).jqGrid({
    	url:'<%=basePath%>room!list.action?department=${param.department}&id=${id}',
		colModel: [
		...
		<tr>
			<td width="100%" valign="top">
				...
				<div class="apptab" id="tableid">
					<ul>
					<li class="apptabli"><a href="<%=basePath%>building!view.action?department=${param.department}&id=${id}">基本信息</a></li>
					<li class="apptabli" ><a href="<%=basePath%>floor!floorView.action?department=${param.department}&id=${id}">视图</a></li>
					<li class="apptabliover" ><a href="<%=basePath%>room!listByBuildingId.action?department=${param.department}&id=${id}">房间信息</a></li>
					</ul>
				</div>
